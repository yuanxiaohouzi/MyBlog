import {
  ...
  we,
  ye
} from "./chunk-OEIPHCXI.js";
import "./chunk-L2SUHFD6.js";
import {
  Je,
  et
} from "./chunk-FOUQHVRE.js";
...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/flowDiagram-d3a638d5.js
function Dt(r2) {
  if (!r2.ok)
...
var bt = function(r2, e, t, n, a, s) {
  ...
  Object.keys(r2).forEach(function(d) {
    ...
    if (ia(Ut().flowchart.htmlLabels)) {
      ...
      const k2 = u.split(Fn.lineBreakRegex);
      for (const B of k2) {
...
var kt = function(r2, e, t) {
  ...
  r2.forEach(function(i) {
    ...
    l.style = y, l.labelStyle = h, i.interpolate !== void 0 ? l.curve = p0(i.interpolate, df) : r2.defaultInterpolate !== void 0 ? l.curve = p0(r2.defaultInterpolate, df) : l.curve = p0(xt.curve, df), i.text === void 0 ? i.style !== void 0 && (l.arrowheadStyle = "fill: #333") : (l.arrowheadStyle = "fill: #333", l.labelpos = "c", ia(Ut().flowchart.htmlLabels) ? (l.labelType = "html", l.label = `<span id="L-${o}" class="edgeLabel L-${c2}' L-${d}" style="${l.labelStyle}">${i.text.replace(
      /fa[blrs]?:fa-[\w-]+/g,
      (u) => `<i class='${u.replace(":", " ")}'></i>`
    )}</span>`) : (l.labelType = "text", l.label = i.text.replace(Fn.lineBreakRegex, `
...
var xe = function(r2, e, t, n) {
  ...
  jg(h, B, s.diagramPadding, s.useMaxWidth), Object.keys(m).forEach(function(g) {
    const b2 = m[g];
    if (b2.link) {
...
//# sourceMappingURL=flowDiagram-d3a638d5-PKV7WYRC.js.map
