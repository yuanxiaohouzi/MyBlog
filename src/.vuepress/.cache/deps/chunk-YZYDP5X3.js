...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/layout-1171b506.js
var Hr = "[object Symbol]";
function R(n) {
  return typeof n == "symbol" || Wn(n) && ai(n) == Hr;
}
function H(n, e) {
...
var kr = 1 / 0;
var fe = Qi ? Qi.prototype : void 0;
var de = fe ? fe.toString : void 0;
function Ke(n) {
  if (typeof n == "string")
    return n;
  if (Xy(n))
...
var ft = function() {
  try {
    var n = Oe(Object, "defineProperty");
    return n({}, "", {}), n;
  } catch {
  }
}();
...
var _t = mt.hasOwnProperty;
function wn(n, e, r) {
  var t = n[e];
  (!(_t.call(n, e) && Xm(t, r)) || r === void 0 && !(e in n)) && bn(n, e, r);
}
function en(n, e, r, t) {
  var i = !r;
  r || (r = {});
...
function z(n, e, r) {
  if (!Wa(r))
    return false;
  var t = typeof e;
  return (t == "number" ? Zy(r) && pn(e, r.length) : t == "string" && e in r) ? Xm(r[e], n) : false;
}
function Et(n) {
...
var Tt = xt.hasOwnProperty;
function Je(n, e) {
  var r = Xy(n), t = !r && Gy(n), i = !r && !t && iC(n), a = !r && !t && !i && MC(n), o = r || t || i || a, u = o ? yt(n.length, String) : [], s = u.length;
  for (var f in n)
...
function qn(n, e) {
  if (Xy(n))
    return false;
  var r = typeof n;
  return r == "number" || r == "symbol" || r == "boolean" || n == null || R(n) ? true : $t.test(n) || !Nt.test(n) || e != null && n in Object(e);
}
var Ct = 500;
function It(n) {
  var e = li(n, function(t) {
...
function _n(n, e) {
  return Xy(n) ? n : qn(n, e) ? [n] : Ft(je(n));
}
var Dt = 1 / 0;
function rn(n) {
...
var ge2 = Qi ? Qi.isConcatSpreadable : void 0;
function Bt(n) {
  return Xy(n) || Gy(n) || !!(ge2 && n && n[ge2]);
}
...
var Yt = wy(Object.getPrototypeOf, Object);
var Wn2 = Yt;
...
var pe = nr && typeof module == "object" && module && !module.nodeType && module;
var ti = pe && pe.exports === nr;
var be = ti ? ie.Buffer : void 0;
var we = be ? be.allocUnsafe : void 0;
function er(n, e) {
  if (e)
    return n.slice();
...
var ai2 = ii.propertyIsEnumerable;
var me = Object.getOwnPropertySymbols;
var oi = me ? function(n) {
...
var _e = Qi ? Qi.prototype : void 0;
var Ee = _e ? _e.valueOf : void 0;
function mi(n) {
...
var Ei = "[object Date]";
var yi = "[object Map]";
var xi = "[object Number]";
var Ti = "[object RegExp]";
var Oi = "[object Set]";
var Li = "[object String]";
var Ai = "[object Symbol]";
var Pi = "[object ArrayBuffer]";
var Ni = "[object DataView]";
var $i = "[object Float32Array]";
var Ci = "[object Float64Array]";
var Ii = "[object Int8Array]";
var Si = "[object Int16Array]";
var Mi = "[object Int32Array]";
var Ri = "[object Uint8Array]";
var Fi = "[object Uint8ClampedArray]";
var Di2 = "[object Uint16Array]";
var Gi = "[object Uint32Array]";
function Bi(n, e, r) {
  var t = n.constructor;
  switch (e) {
    case Pi:
...
function ur(n) {
  return typeof n.constructor == "function" && !Cl(n) ? rt(Wn2(n)) : {};
}
var Ui = "[object Map]";
function Yi(n) {
  return Wn(n) && Wy(n) == Ui;
...
var ea = "[object GeneratorFunction]";
var ra = "[object Map]";
var ta = "[object Number]";
var dr = "[object Object]";
var ia = "[object RegExp]";
var aa = "[object Set]";
var oa = "[object String]";
var ua = "[object Symbol]";
var sa = "[object WeakMap]";
var fa = "[object ArrayBuffer]";
var da = "[object DataView]";
var ca = "[object Float32Array]";
var la = "[object Float64Array]";
var ha = "[object Int8Array]";
var va = "[object Int16Array]";
var ga = "[object Int32Array]";
var pa = "[object Uint8Array]";
var ba = "[object Uint8ClampedArray]";
var wa = "[object Uint16Array]";
var ma = "[object Uint32Array]";
var w = {};
w[sr] = w[Ji] = w[fa] = w[da] = w[ji] = w[Qi2] = w[ca] = w[la] = w[ha] = w[va] = w[ga] = w[ra] = w[ta] = w[dr] = w[ia] = w[aa] = w[oa] = w[ua] = w[pa] = w[ba] = w[wa] = w[ma] = true;
w[na] = w[fr] = w[sa] = false;
...
function lr(n, e, r, t, i, a) {
  ...
  if (f && d)
    return f == e && d == n;
  var l = -1, h = true, g = r & Pa ? new J() : void 0;
...
var $a = 1;
var Ca = 2;
var Ia = "[object Boolean]";
var Sa = "[object Date]";
var Ma = "[object Error]";
var Ra = "[object Map]";
var Fa = "[object Number]";
var Da = "[object RegExp]";
var Ga = "[object Set]";
var Ba = "[object String]";
var Ua = "[object Symbol]";
var Ya = "[object ArrayBuffer]";
var Ha2 = "[object DataView]";
var Te = Qi ? Qi.prototype : void 0;
var An = Te ? Te.valueOf : void 0;
...
var Za = 1;
var Oe2 = "[object Arguments]";
var Le = "[object Array]";
var sn = "[object Object]";
var Va = Object.prototype;
var Ae = Va.hasOwnProperty;
function za(n, e, r, t, i, a) {
  var o = Xy(n), u = Xy(e), s = o ? Le : Wy(n), f = u ? Le : Wy(e);
  s = s == Oe2 ? sn : s, f = f == Oe2 ? sn : f;
  ...
  if (h && !d)
    return a || (a = new O()), o || MC(n) ? lr(n, e, r, t, i, a) : ka(n, e, s, r, t, i, a);
  if (!(r & Za)) {
  ...
  return h ? (a || (a = new O()), Xa(n, e, r, t, i, a)) : false;
}
function zn(n, e, r, t, i) {
  return n === e ? true : n == null || e == null || !Wn(n) && !Wn(e) ? n !== n && e !== e : za(n, e, r, t, zn, i);
}
var Ja = 1;
var ja = 2;
function Qa(n, e, r, t) {
  ...
  for (; ++i < a; ) {
    ...
    if (o && u[2]) {
      ...
      if (t)
        var h = t(f, d, s, n, e, l);
      if (!(h === void 0 ? zn(d, f, Ja | ja, t, l) : h))
        return false;
    }
  }
  return true;
...
function gr(n, e, r) {
  ...
  return a || ++t != i ? a : (i = n == null ? 0 : n.length, !!i && bl(i) && pn(o, i) && (Xy(n) || Gy(n)));
}
function pr(n, e) {
...
function C(n) {
  return typeof n == "function" ? n : n == null ? G : typeof n == "object" ? Xy(n) ? ao(n[0], n[1]) : eo(n) : so(n);
}
function fo(n) {
...
var go = br.hasOwnProperty;
var po = mn(function(n, e) {
  n = Object(n);
  var r = -1, t = e.length, i = t > 2 ? e[2] : void 0;
  for (i && z(e[0], e[1], i) && (t = 1); ++r < t; )
    for (var a = e[r], o = B(a), u = -1, s = o.length; ++u < s; ) {
      var f = o[u], d = n[f];
      (d === void 0 || Xm(d, br[f]) && !go.call(n, f)) && (n[f] = a[f]);
    }
  return n;
});
var bo = po;
function Fn(n, e, r) {
  (r !== void 0 && !Xm(n[e], r) || r === void 0 && !(e in n)) && bn(n, e, r);
}
function wr(n) {
  return Wn(n) && Zy(n);
}
...
function mo(n, e, r, t, i, a, o) {
  ...
  if (l) {
    var h = Xy(s), g = !h && iC(s), v = !h && !g && MC(s);
    d = s, h || g || v ? Xy(u) ? d = u : wr(u) ? d = We(u) : g ? (l = false, d = er(s, true)) : v ? (l = false, d = or(s, true)) : d = [] : Xt(s) || Gy(s) ? (d = u, Gy(u) ? d = wo(u) : (!Wa(u) || Ha(u)) && (d = ur(s))) : l = false;
  }
...
function Mo(n, e, r, t) {
  ...
  for (var i = -1, a = e.length, o = a - 1, u = n; u != null && ++i < a; ) {
    ...
    if (i != o) {
      var d = u[s];
      f = t ? t(d, s, u) : void 0, f === void 0 && (f = Wa(d) ? d : pn(e[i + 1]) ? [] : {});
    }
    wn(u, s, f), u = u[s];
  }
  return n;
...
function Ko(n) {
  return function(e, r, t) {
    return t && typeof t != "number" && z(e, r, t) && (r = t = void 0), e = fn2(e), r === void 0 ? (r = e, e = 0) : r = fn2(r), t = t === void 0 ? e < r ? 1 : -1 : fn2(t), qo(e, r, t, n);
  };
}
var Wo = Ko();
var k = Wo;
...
function tn(n, e, r) {
  var t = Xy(n) ? Zt : Xo, i = arguments.length < 3;
...
var Zo = mn(function(n, e) {
  if (n == null)
    return [];
  var r = e.length;
  return r > 1 && z(n, e[0], e[1]) ? e = [] : r > 2 && z(e[0], e[1], e[2]) && (e = [e[0]]), Bo(n, yn(e, 1), []);
});
var an = Zo;
var Vo = 1 / 0;
var zo = fn && 1 / Vn(new fn([, -0]))[1] == Vo ? function(n) {
  return new fn(n);
} : it;
var Jo = zo;
var jo = 200;
function Qo(n, e, r) {
  var t = -1, i = pt, a = n.length, o = true, u = [], s = u;
  if (r)
    o = false, i = _o;
  else if (a >= jo) {
    var f = e ? null : Jo(n);
...
var A = class {
  ...
  setDefaultNodeLabel(e) {
    return Ha(e) || (e = Y(e)), this._defaultNodeLabelFn = e, this;
  }
  nodeCount() {
  ...
  setNode(e, r) {
    return b(this._nodes, e) ? (arguments.length > 1 && (this._nodes[e] = r), this) : (this._nodes[e] = arguments.length > 1 ? r : this._defaultNodeLabelFn(e), this._isCompound && (this._parent[e] = S, this._children[e] = {}, this._children[S][e] = true), this._in[e] = {}, this._preds[e] = {}, this._out[e] = {}, this._sucs[e] = {}, ++this._nodeCount, this);
  }
  node(e) {
  ...
  setDefaultEdgeLabel(e) {
    return Ha(e) || (e = Y(e)), this._defaultEdgeLabelFn = e, this;
  }
  edgeCount() {
...
var uu = class {
  ...
  enqueue(e) {
    ...
    e._prev && e._next && Ie2(e), e._next = r._next, r._next._prev = e, r._next = e, e._prev = r;
  }
  toString() {
...
function hu(n) {
  ...
  c(e, function(t) {
    var i = n.edge(t);
    n.removeEdge(t), i.forwardName = t.name, i.reversed = true, n.setEdge(t.w, t.v, i, te("rev"));
  });
  function r(t) {
    return function(i) {
...
function vu(n) {
  var e = [], r = {}, t = {};
  function i(a) {
    b(t, a) || (t[a] = true, r[a] = true, c(n.outEdges(a), function(o) {
...
function Or(n) {
  ...
  e.setNode(r, {});
  for (var i, a; $u(e, n) < t; )
    i = Cu(e, n), a = e.hasNode(i.v) ? Q(n, i) : -Q(n, i), Iu(e, n, a);
  return e;
}
function $u(n, e) {
  function r(t) {
...
function Ar(n, e, r, t, i, a) {
  b(t, e) || (t[e] = true, r || a.push(e), c(i(e), function(o) {
    Ar(n, o, r, t, i, a);
  }), r && a.push(e));
}
function Mu(n, e) {
...
function Xu(n, e, r) {
  var t = Zu(n), i = new A({ compound: true }).setGraph({ root: t }).setDefaultNodeLabel(function(a) {
    return n.node(a);
  });
...
function ss2(n) {
  ...
  c(n.graph().dummyChains, function(r) {
    for (var t = n.node(r), i = t.edgeObj, a = fs(n, e, i.v, i.w), o = a.path, u = a.lca, s = 0, f = o[s], d = true; r !== i.w; ) {
      if (t = n.node(r), d) {
...
var Ps = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"];
var Ns = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" };
var $s = ["acyclicer", "ranker", "rankdir", "align"];
var Cs = ["width", "height"];
var Is = { width: 0, height: 0 };
var Ss = ["minlen", "weight", "width", "height", "labeloffset"];
var Ms = {
  minlen: 1,
  weight: 1,
  width: 0,
...
//# sourceMappingURL=chunk-YZYDP5X3.js.map
