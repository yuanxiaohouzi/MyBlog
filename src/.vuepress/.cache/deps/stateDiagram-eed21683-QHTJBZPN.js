...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/stateDiagram-eed21683.js
var T = {};
var $ = (e, n) => {
  T[e] = n;
};
...
var tt = (e, n, o, d) => {
  ...
  let p = e.replace(/\r\n/g, "<br/>");
  p = p.replace(/\n/g, "<br/>");
  const a = p.split(Fn.lineBreakRegex);
...
var at = function(e, n, o) {
  ...
  const s = n.points, g = S().x(function(r) {
    ...
    return r.y;
  }).curve(mf), p = e.append("path").attr("d", g(s)).attr("id", "edge" + A2).attr("class", "transition");
  let a = "";
  if (Ut().state.arrowMarkerAbsolute && (a = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, a = a.replace(/\(/g, "\\("), a = a.replace(/\)/g, "\\)")), p.attr(
    ...
    const r = e.append("g").attr("class", "stateLabel"), { x: w, y: x } = Oi.calcLabelPosition(n.points), l = Fn.getRows(o.title);
    let c = 0;
    const m = [];
    let f = 0, S3 = 0;
...
var st = function(e, n, o, d) {
  ...
  Hg(r, f, S3, B.useMaxWidth), r.attr(
    "viewBox",
  ...
  l.forEach(function(i) {
    m++, S2.debug("Setting edge", i), a.setEdge(
      ...
      i.id2,
      {
        relation: i,
        width: rt(i.title),
        height: B.labelHeight * Fn.getRows(i.title).length,
        labelpos: "c"
      },
      "id" + m
    );
...
//# sourceMappingURL=stateDiagram-eed21683-QHTJBZPN.js.map
