...
var mt = function() {
  var t = function(D, r, a, i) {
    ...
    parse: function(r) {
      var a = this, i = [0], l = [], y = [null], e = [], B = this.table, c = "", C = 0, O = 0, it = 2, $ = 1, pt = e.slice.call(arguments, 1), S2 = Object.create(this.lexer), A = { yy: {} };
      for (var yt in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, yt) && (A.yy[yt] = this.yy[yt]);
      S2.setInput(r, A.yy), A.yy.lexer = S2, A.yy.parser = this, typeof S2.yylloc > "u" && (S2.yylloc = {});
      var St = S2.yylloc;
      e.push(St);
      var zt = S2.options && S2.options.ranges;
      typeof A.yy.parseError == "function" ? this.parseError = A.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function Mt() {
        var E;
        return E = l.pop() || S2.lex() || $, typeof E != "number" && (E instanceof Array && (l = E, E = l.pop()), E = a.symbols_[E] || E), E;
      }
      for (var _, L, m, gt, N = {}, rt, b, Lt, nt; ; ) {
        if (L = i[i.length - 1], this.defaultActions[L] ? m = this.defaultActions[L] : ((_ === null || typeof _ > "u") && (_ = Mt()), m = B[L] && B[L][_]), typeof m > "u" || !m.length || !m[0]) {
          ...
          S2.showPosition ? _t = "Parse error on line " + (C + 1) + `:
` + S2.showPosition() + `
Expecting ` + nt.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : _t = "Parse error on line " + (C + 1) + ": Unexpected " + (_ == $ ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(_t, {
        ...
        switch (m[0]) {
          case 1:
            i.push(_), y.push(S2.yytext), e.push(S2.yylloc), i.push(m[1]), _ = null, O = S2.yyleng, c = S2.yytext, C = S2.yylineno, St = S2.yylloc;
            break;
          case 2:
...
` + a + "^";
      ...
      next: function() {
        ...
        for (var y = this._currentRules(), e = 0; e < y.length; e++)
          if (i = this._input.match(this.rules[y[e]]), i && (!a || i[0].length > a[0].length)) {
            if (a = i, l = e, this.options.backtrack_lexer) {
              if (r = this.test_match(i, y[e]), r !== false)
                return r;
              if (this._backtrack) {
                a = false;
                continue;
        ...
        return a ? (r = this.test_match(a, y[l]), r !== false ? r : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
var oe = function(t, s, n) {
  de.parseDirective(this, t, s, n);
};
var he = (t) => {
...
var ct = (t, s, n) => {
  if (s.stmt === Rt)
    ct(t, s.state1, true), ct(t, s.state2, false);
    ...
    s.doc.forEach((p) => ct(s, p, true));
  }
};
var de2 = () => (ct({ id: "root" }, { id: "root", doc: lt }, true), { id: "root", doc: lt });
var fe = (t) => {
  let s;
  t.doc ? s = t.doc : s = t, S.info(s), Yt(true), S.info("Extract", s), s.forEach((n) => {
    switch (n.stmt) {
      case Tt:
        I(
          n.id.trim(),
...
var I = function(t, s = xt, n = null, h = null, u = null, f = null, p = null, v = null) {
  ...
  g.states[d] === void 0 ? (S.info("Adding state ", d, h), g.states[d] = {
    ...
    styles: [],
    textStyles: []
  }) : (g.states[d].doc || (g.states[d].doc = n), g.states[d].type || (g.states[d].type = s)), h && (S.info("Setting state description", d, h), typeof h == "string" && Et(d, h.trim()), typeof h == "object" && h.forEach((k) => Et(d, k.trim()))), u && (g.states[d].note = u, g.states[d].note.text = Fn.sanitizeText(
    g.states[d].note.text,
    Ut()
  )), f && (S.info("Setting state classes", d, f), (typeof f == "string" ? [f] : f).forEach((T) => Dt(d, T.trim()))), p && (S.info("Setting state styles", d, p), (typeof p == "string" ? [p] : p).forEach((T) => Ee(d, T.trim()))), v && (S.info("Setting state styles", d, p), (typeof v == "string" ? [v] : v).forEach((T) => xe(d, T.trim())));
};
var Yt = function(t) {
  ot = {
    root: Ft()
...
function me(t, s, n) {
  ...
  I(
    ...
    id1: h,
    id2: f,
    relationTitle: Fn.sanitizeText(n, Ut())
  });
}
var Gt = function(t, s, n) {
  if (typeof t == "object")
    me(t, s, n);
  else {
    ...
    I(h, u), I(f, p), g.relations.push({
      id1: h,
      id2: f,
      title: Fn.sanitizeText(n, Ut())
    });
  }
};
var Et = function(t, s) {
  const n = g.states[t], h = s.startsWith(":") ? s.replace(":", "").trim() : s;
  n.descriptions.push(Fn.sanitizeText(h, Ut()));
};
var Te = function(t) {
...
//# sourceMappingURL=chunk-33FKGKT2.js.map
