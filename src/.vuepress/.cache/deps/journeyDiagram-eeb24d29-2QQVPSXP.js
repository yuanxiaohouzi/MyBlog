...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/journeyDiagram-eeb24d29.js
var Z = function() {
...
`);
  ...
  Hg(u, b, _, i.useMaxWidth), u.append("line").attr("x1", C).attr("y1", i.height * 4).attr("x2", _ - C - 4).attr("y2", i.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  const r = g ? 70 : 0;
...
//# sourceMappingURL=journeyDiagram-eeb24d29-2QQVPSXP.js.map
