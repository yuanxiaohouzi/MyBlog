...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/svgDraw-39291d2f.js
var E = 0;
var O = function(i, e, t, n, r) {
  ...
  const l = e.points, g = S().x(function(d) {
    ...
    return d.y;
  }).curve(mf), s = i.append("path").attr("d", g(l)).attr("id", "edge" + E).attr("class", "relation");
  let p = "";
  ...
  let b = Oi.calcLabelPosition(e.points);
  h = b.x, a = b.y;
  let u, m, B, T;
  if (c % 2 !== 0 && c > 1) {
    let d = Oi.calcCardinalityPosition(
      t.relation.type1 !== "none",
      e.points,
      e.points[0]
    ), w = Oi.calcCardinalityPosition(
      t.relation.type2 !== "none",
      e.points,
      e.points[c - 1]
    );
    S2.debug("cardinality_1_point " + JSON.stringify(d)), S2.debug("cardinality_2_point " + JSON.stringify(w)), u = d.x, m = d.y, B = w.x, T = w.y;
  }
  if (t.title !== void 0) {
  ...
  S2.info("Rendering relation " + JSON.stringify(t)), t.relationTitle1 !== void 0 && t.relationTitle1 !== "none" && i.append("g").attr("class", "cardinality").append("text").attr("class", "type1").attr("x", u).attr("y", m).attr("fill", "black").attr("font-size", "6").text(t.relationTitle1), t.relationTitle2 !== void 0 && t.relationTitle2 !== "none" && i.append("g").attr("class", "cardinality").append("text").attr("class", "type2").attr("x", B).attr("y", T).attr("fill", "black").attr("font-size", "6").text(t.relationTitle2), E++;
};
var P = function(i, e, t, n) {
  S2.debug("Rendering class ", e, t);
  const r = e.id, o = {
    id: r,
    label: e.id,
    width: 0,
...
`);
  s.forEach(function(c) {
    S2.debug(`Adding line: ${c}`), g.append("tspan").text(c).attr("class", "title").attr("dy", t.textHeight);
  });
...
var M = function(i) {
  ...
  if (h > 1 && a > h && a <= i.length) {
    ...
    if (e = r + b + "(" + ad(u.trim()) + ")", a < i.length) {
      let m = i.substring(a + 1, a + 2);
      t === "" && !m.match(g) ? (t = _(m), n = i.substring(a + 2).trim()) : n = i.substring(a + 1).trim(), n !== "" && (n.charAt(0) === ":" && (n = n.substring(1).trim()), n = " : " + ad(n), e += n);
    }
  } else
    e = r + ad(i);
  return {
...
//# sourceMappingURL=chunk-Y4IJOOFO.js.map
