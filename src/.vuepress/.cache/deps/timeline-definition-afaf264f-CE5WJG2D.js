...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/timeline-definition-afaf264f.js
var Y = function() {
  var n = function(k, r, a, h) {
    for (a = a || {}, h = k.length; h--; a[k[h]] = r)
      ;
    return a;
  }, t = [1, 2], e = [1, 5], s = [6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], i = [1, 15], o = [1, 16], l = [1, 17], y = [1, 18], f = [1, 19], d = [1, 23], m = [1, 24], S2 = [1, 27], _ = [4, 6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], b = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(r, a, h, u, g, c, M) {
      var x = c.length - 1;
      switch (g) {
        case 1:
          return c[x - 1];
    ...
    table: [{ 3: 1, 4: t, 7: 3, 12: 4, 28: e }, { 1: [3] }, n(s, [2, 3], { 5: 6 }), { 3: 7, 4: t, 7: 3, 12: 4, 28: e }, { 13: 8, 29: [1, 9] }, { 29: [2, 21] }, { 6: [1, 10], 7: 22, 8: 11, 9: [1, 12], 10: 13, 11: [1, 14], 12: 4, 17: i, 18: o, 20: l, 22: y, 23: f, 24: 20, 25: 21, 26: d, 27: m, 28: e }, { 1: [2, 2] }, { 14: 25, 15: [1, 26], 31: S2 }, n([15, 31], [2, 22]), n(s, [2, 8], { 1: [2, 1] }), n(s, [2, 4]), { 7: 22, 10: 28, 12: 4, 17: i, 18: o, 20: l, 22: y, 23: f, 24: 20, 25: 21, 26: d, 27: m, 28: e }, n(s, [2, 6]), n(s, [2, 7]), n(s, [2, 11]), { 19: [1, 29] }, { 21: [1, 30] }, n(s, [2, 14]), n(s, [2, 15]), n(s, [2, 16]), n(s, [2, 17]), n(s, [2, 18]), n(s, [2, 19]), n(s, [2, 20]), { 11: [1, 31] }, { 16: 32, 30: [1, 33] }, { 11: [2, 24] }, n(s, [2, 5]), n(s, [2, 12]), n(s, [2, 13]), n(_, [2, 9]), { 14: 34, 31: S2 }, { 31: [2, 23] }, { 11: [1, 35] }, n(_, [2, 10])],
    ...
    parse: function(r) {
      var a = this, h = [0], u = [], g = [null], c = [], M = this.table, x = "", C = 0, O = 0, G = 2, j = 1, P = c.slice.call(arguments, 1), p = Object.create(this.lexer), E = { yy: {} };
      ...
      var H = p.yylloc;
      c.push(H);
      var z = p.options && p.options.ranges;
      typeof E.yy.parseError == "function" ? this.parseError = E.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function et() {
        var A2;
        return A2 = u.pop() || p.lex() || j, typeof A2 != "number" && (A2 instanceof Array && (u = A2, A2 = u.pop()), A2 = a.symbols_[A2] || A2), A2;
      }
      for (var w, V, N, Q, F2 = {}, q, $, nt, U; ; ) {
        if (V = h[h.length - 1], this.defaultActions[V] ? N = this.defaultActions[V] : ((w === null || typeof w > "u") && (w = et()), N = M[V] && M[V][w]), typeof N > "u" || !N.length || !N[0]) {
          var X = "";
          U = [];
          for (q in M[V])
...
Expecting ` + U.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : X = "Parse error on line " + (C + 1) + ": Unexpected " + (w == j ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(X, {
        ...
        switch (N[0]) {
          case 1:
            h.push(w), g.push(p.yytext), c.push(p.yylloc), h.push(N[1]), w = null, O = p.yyleng, x = p.yytext, C = p.yylineno, H = p.yylloc;
            break;
          case 2:
            if ($ = this.productions_[N[1]][1], F2.$ = g[g.length - $], F2._$ = {
              ...
              return Q;
            $ && (h = h.slice(0, -1 * $ * 2), g = g.slice(0, -1 * $), c = c.slice(0, -1 * $)), h.push(this.productions_[N[1]][0]), g.push(F2.$), c.push(F2._$), nt = M[h[h.length - 2]][h[h.length - 1]], h.push(nt);
            break;
          case 3:
            return true;
        }
...
` + a + "^";
      ...
      next: function() {
        ...
        for (var g = this._currentRules(), c = 0; c < g.length; c++)
          if (h = this._input.match(this.rules[g[c]]), h && (!a || h[0].length > a[0].length)) {
            if (a = h, u = c, this.options.backtrack_lexer) {
              if (r = this.test_match(h, g[c]), r !== false)
                return r;
              if (this._backtrack) {
                a = false;
                continue;
        ...
        return a ? (r = this.test_match(a, g[u]), r !== false ? r : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
var ht = function() {
  D.length = 0, J.length = 0, W = "", B.length = 0, Fa();
};
var dt = function(n) {
  W = n, D.push(n);
};
...
var Ht = function(n, t) {
  function e(i, o, l, y, f) {
    return i + "," + o + " " + (i + l) + "," + o + " " + (i + l) + "," + (o + y - f) + " " + (i + l - f * 1.2) + "," + (o + y) + " " + i + "," + (o + y);
  }
...
var rt = -1;
var zt = function(n, t, e) {
  const s = t.x + e.width / 2, i = n.append("g");
  rt++;
  const o = 300 + 5 * 30;
  i.append("line").attr("id", "task" + rt).attr("x1", s).attr("y1", t.y).attr("x2", s).attr("y2", o).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), At2(i, {
    cx: s,
    cy: 300 + (5 - t.score) * 30,
    score: t.score
  });
...
var xt = function() {
  function n(i, o, l, y, f, d, m, S2) {
    const _ = o.append("text").attr("x", l + f / 2).attr("y", y + d / 2 + 5).style("font-color", S2).style("text-anchor", "middle").text(i);
    s(_, m);
  }
  function t(i, o, l, y, f, d, m, S2, _) {
    const { taskFontSize: b, taskFontFamily: v } = S2, I = i.split(/<br\s*\/?>/gi);
    for (let k = 0; k < I.length; k++) {
      const r = k * b - b * (I.length - 1) / 2, a = o.append("text").attr("x", l + f / 2).attr("y", y).attr("fill", _).style("text-anchor", "middle").style("font-size", b).style("font-family", v);
      a.append("tspan").attr("x", l + f / 2).attr("dy", r).text(I[k]), a.attr("y", y + d / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), s(a, m);
    }
  }
  function e(i, o, l, y, f, d, m, S2) {
    const _ = o.append("switch"), v = _.append("foreignObject").attr("x", l).attr("y", y).attr("width", f).attr("height", d).attr("position", "fixed").append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    v.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), t(i, _, l, y, f, d, m, S2), s(v, m);
  }
  function s(i, o) {
    for (const l in o)
      l in o && i.attr(l, o[l]);
...
function _t(n, t) {
  n.each(function() {
    var e = At(this), s = e.text().split(/(\s+|<br>)/).reverse(), i, o = [], l = 1.1, y = e.attr("y"), f = parseFloat(e.attr("dy")), d = e.text(null).append("tspan").attr("x", 0).attr("y", y).attr("dy", f + "em");
...
`), S.debug("timeline", s.db);
  ...
  const d = (l === "sandbox" ? (
    ...
    At(y.nodes()[0].contentDocument.body)
  ) : At("body")).select("#" + t);
  d.append("g");
  const m = s.db.getTasks(), S2 = s.db.getCommonDb().getDiagramTitle();
  S.debug("task", m), R.initGraphics(d);
  ...
  _.forEach(function(P) {
    ...
    S.debug("sectionHeight before draw", E), b = Math.max(b, E + 20);
  });
  let g = 0, c = 0;
  S.debug("tasks.length", m.length);
  for (const [P, p] of m.entries()) {
    ...
    S.debug("taskHeight before draw", L), v = Math.max(v, L + 20), g = Math.max(g, p.events.length);
    let H = 0;
    for (let z = 0; z < p.events.length; z++) {
      const w = {
        descr: p.events[z],
        section: p.section,
        number: p.section,
  ...
  S.debug("maxSectionHeight before draw", b), S.debug("maxTaskHeight before draw", v), _ && _.length > 0 ? _.forEach((P) => {
    const p = m.filter((z) => z.section === P), E = {
      number: h,
      descr: P,
      section: h,
    ...
    S.debug("sectionNode", E);
    const L = d.append("g"), H = R.drawNode(L, E, h, i);
    S.debug("sectionNode output", H), L.attr("transform", `translate(${r}, ${k})`), a += b + 50, p.length > 0 && at(
      d,
      p,
      h,
      r,
  ...
  S.debug("bounds", M), S2 && d.append("text").text(S2).attr("x", M.width / 2 - o).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), I = u ? b + v + 150 : v + 100, d.append("g").attr("class", "lineWrapper").append("line").attr("x1", o).attr("y1", I).attr("x2", M.width + 3 * o).attr("y2", I).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), jg(
    void 0,
    d,
...
var at = function(n, t, e, s, i, o, l, y, f, d, m) {
  var S2;
  for (const _ of t) {
    const b = {
      descr: _.task,
    ...
    if (S.debug("taskHeight after draw", k), v.attr("transform", `translate(${s}, ${i})`), o = Math.max(o, k), _.events) {
    ...
    s = s + 200, m && !((S2 = l.timeline) != null && S2.disableMulticolor) && e++;
  }
  i = i - 10;
};
...
var Ut2 = (n) => {
  ...
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
    n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], si(n["lineColor" + e]) ? n["lineColor" + e] = F(n["lineColor" + e], 20) : n["lineColor" + e] = A(n["lineColor" + e], 20);
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
    const s = "" + (17 - 3 * e);
    t += `
...
//# sourceMappingURL=timeline-definition-afaf264f-CE5WJG2D.js.map
