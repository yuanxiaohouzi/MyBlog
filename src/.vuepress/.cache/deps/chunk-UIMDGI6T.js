...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/createText-34ecf23e.js
function zt(n, r) {
  var { includeImageAlt: t = true } = r || {};
  return tt(n, t);
}
function tt(n, r) {
...
function qt(n) {
  ...
  function B(F) {
    if (F === null) {
      D(n.exit("chunkFlow"), true), y(0), n.consume(F);
      return;
    }
  ...
  function u(i) {
    if (i === 62) {
      ...
      return l.open || (n.enter("blockQuote", {
        _container: true
      }), l.open = true), n.enter("blockQuotePrefix"), n.enter("blockQuoteMarker"), n.consume(i), n.exit("blockQuoteMarker"), a;
    }
    return t(i);
  }
  function a(i) {
...
var Wn = document.createElement("i");
function Ln(n) {
  const r = "&" + n + ";";
  Wn.innerHTML = r;
...
function Kt(n, r, t) {
  const e = this, u = {
    ...
    tokenize: L,
    partial: true
  }, i = this.events[this.events.length - 1], l = i && i[1].type === "linePrefix" ? i[2].sliceSerialize(i[1], true).length : 0;
  let c = 0, p;
  return h;
  function h(d) {
  ...
  function L(d, P, R) {
    ...
    return V;
    function V(w) {
      return d.enter("lineEnding"), d.consume(w), d.exit("lineEnding"), S2;
    }
    function S2(w) {
  ...
  function O(d, P, R) {
    ...
    function V(A) {
      return d.enter("codeFencedFence"), d.enter("codeFencedFenceSequence"), S2(A);
    }
    function S2(A) {
      return A === p ? (d.consume(A), j++, S2) : j < c ? R(A) : (d.exit("codeFencedFenceSequence"), T(d, w, "whitespace")(A));
    }
    function w(A) {
...
function vt(n, r, t) {
  ...
  function a(p) {
    ...
    return h && h[1].type === "linePrefix" && h[2].sliceSerialize(h[1], true).length >= 4 ? i(p) : t(p);
  }
  function i(p) {
...
function ne(n, r, t) {
  ...
  function a(i) {
    ...
    return l && l[1].type === "linePrefix" && l[2].sliceSerialize(l[1], true).length >= 4 ? r(i) : C(i) ? u(i) : t(i);
  }
}
var te = {
  name: "codeText",
  ...
  for (; ++t < n.length; ) {
    ...
    if (e = n[t], t && e[1].type === "chunkFlow" && n[t - 1][1].type === "listItemPrefix" && (c = e[1]._tokenizer.events, a = 0, a < c.length && c[a][1].type === "lineEndingBlank" && (a += 2), a < c.length && c[a][1].type === "content"))
      for (; ++a < c.length && c[a][1].type !== "content"; )
        c[a][1].type === "chunkText" && (c[a][1]._isInFirstContentOfListItem = true, a++);
    if (e[0] === "enter")
      e[1].contentType && (Object.assign(r, ue(n, t)), t = r[t], p = true);
...
function ue(n, r) {
  ...
  for (; f; ) {
    for (; n[++u][1] !== f; )
      ;
    a.push(u), f._tokenizer || (h = e.sliceStream(f), f.next || h.push(null), x && i.defineSkip(f.start), f._isInFirstContentOfListItem && (i._gfmTasklistFirstContentOfListItem = true), i.write(h), f._isInFirstContentOfListItem && (i._gfmTasklistFirstContentOfListItem = void 0)), x = f, f = f.next;
  }
  for (f = t; ++g < l.length; )
...
function ce(n, r, t) {
  ...
  function a(i) {
    if (i === null || C(i))
      return t(i);
    const l = e.events[e.events.length - 1];
    return !e.parser.constructs.disable.null.includes("codeIndented") && l && l[1].type === "linePrefix" && l[2].sliceSerialize(l[1], true).length >= 4 ? r(i) : n.interrupt(e.parser.constructs.flow, t, r)(i);
  }
}
...
function dn(n, r) {
  ...
  return e;
  function e(u) {
    return C(u) ? (n.enter("lineEnding"), n.consume(u), n.exit("lineEnding"), t = true, e) : q(u) ? T(
      n,
      e,
...
var Zn = ["pre", "script", "style", "textarea"];
var Se = {
  name: "htmlFlow",
  tokenize: Ee,
  resolveTo: we,
...
function Ee(n, r, t) {
  ...
  function h(o) {
    return o === 33 ? (n.consume(o), x) : o === 47 ? (n.consume(o), k) : o === 63 ? (n.consume(o), u = 3, e.interrupt ? r : W) : tn(o) ? (n.consume(o), i = String.fromCharCode(o), a = true, B) : t(o);
  }
  function x(o) {
  ...
  function f(o) {
    return o === i.charCodeAt(l++) ? (n.consume(o), l === i.length ? e.interrupt ? r : S2 : f) : t(o);
  }
  function k(o) {
    return tn(o) ? (n.consume(o), i = String.fromCharCode(o), B) : t(o);
  }
  function B(o) {
    return o === null || o === 47 || o === 62 || Y(o) ? o !== 47 && a && Zn.includes(i.toLowerCase()) ? (u = 1, e.interrupt ? r(o) : S2(o)) : ye.includes(i.toLowerCase()) ? (u = 6, o === 47 ? (n.consume(o), D) : e.interrupt ? r(o) : S2(o)) : (u = 7, e.interrupt && !e.parser.lazy[e.now().line] ? t(o) : a ? _(o) : y(o)) : o === 45 || v(o) ? (n.consume(o), i += String.fromCharCode(o), B) : t(o);
  }
  function D(o) {
    return o === 62 ? (n.consume(o), e.interrupt ? r : S2) : t(o);
  }
  function y(o) {
  ...
  function V(o) {
    return q(o) ? (n.consume(o), V) : o === null || C(o) ? S2(o) : t(o);
  }
  function S2(o) {
    return o === 45 && u === 2 ? (n.consume(o), G) : o === 60 && u === 1 ? (n.consume(o), nn) : o === 62 && u === 4 ? (n.consume(o), H) : o === 63 && u === 3 ? (n.consume(o), W) : o === 93 && u === 5 ? (n.consume(o), Q) : C(o) && (u === 6 || u === 7) ? n.check(
      ...
      H,
      w
    )(o) : o === null || C(o) ? w(o) : (n.consume(o), S2);
  }
  function w(o) {
  ...
  function G(o) {
    return o === 45 ? (n.consume(o), W) : S2(o);
  }
  function nn(o) {
    return o === 47 ? (n.consume(o), i = "", J) : S2(o);
  }
  function J(o) {
    return o === 62 && Zn.includes(i.toLowerCase()) ? (n.consume(o), H) : tn(o) && i.length < 8 ? (n.consume(o), i += String.fromCharCode(o), J) : S2(o);
  }
  function Q(o) {
    return o === 93 ? (n.consume(o), W) : S2(o);
  }
  function W(o) {
    return o === 62 ? (n.consume(o), H) : o === 45 && u === 2 ? (n.consume(o), W) : S2(o);
  }
  function H(o) {
...
function ze(n, r, t) {
  ...
  function V(s) {
    return s === 45 || v(s) ? (n.consume(s), V) : s === 47 || s === 62 || Y(s) ? S2(s) : t(s);
  }
  function S2(s) {
    return s === 47 ? (n.consume(s), H) : s === 58 || s === 95 || tn(s) ? (n.consume(s), w) : C(s) ? (l = S2, Q(s)) : q(s) ? (n.consume(s), S2) : H(s);
  }
  function w(s) {
    return s === 45 || s === 46 || s === 58 || s === 95 || v(s) ? (n.consume(s), w) : A(s);
  }
  function A(s) {
    return s === 61 ? (n.consume(s), U) : C(s) ? (l = A, Q(s)) : q(s) ? (n.consume(s), A) : S2(s);
  }
  function U(s) {
  ...
  function nn(s) {
    return s === 62 || s === 47 || Y(s) ? S2(s) : t(s);
  }
  function J(s) {
    return s === null || s === 34 || s === 39 || s === 60 || s === 61 || s === 96 ? t(s) : s === 62 || Y(s) ? S2(s) : (n.consume(s), J);
  }
  function Q(s) {
...
function We(n, r, t) {
  ...
  function h(f) {
    return e.containerState.initialBlankLine = true, a++, g(f);
  }
  function x(f) {
    return q(f) ? (n.enter("listItemPrefixWhitespace"), n.consume(f), n.exit("listItemPrefixWhitespace"), g) : t(f);
  }
  function g(f) {
    return e.containerState.size = a + e.sliceSerialize(n.exit("listItemPrefix"), true).length, r(f);
  }
}
function $e(n, r, t) {
  const e = this;
  ...
  function i(l) {
    return e.containerState._closeFlow = true, e.interrupt = void 0, T(
      n,
      n.attempt($, r, t),
      "linePrefix",
      e.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4
...
function Ze(n, r, t) {
  ...
  function u(a) {
    ...
    return i && i[1].type === "listItemIndent" && i[2].sliceSerialize(i[1], true).length === e.containerState.size ? r(a) : t(a);
  }
}
function Ye(n) {
...
function ir(n, r, t) {
  ...
  function x(S2) {
    return i = Z(i, S2), D(), i[i.length - 1] !== null ? [] : (R(r, 0), p.events = Bn(a, p.events, p), p.events);
  }
  function g(S2, w) {
    return ar(f(S2), w);
  }
  ...
  function D() {
    ...
    for (; e._index < i.length; ) {
      const w = i[e._index];
      if (typeof w == "string")
        for (S2 = e._index, e._bufferIndex < 0 && (e._bufferIndex = 0); e._index === S2 && e._bufferIndex < w.length; )
  ...
  function _(S2) {
    C(S2) ? (e.line++, e.column = 1, e.offset += S2 === -3 ? 2 : 1, V()) : S2 !== -1 && (e.column++, e.offset++), e._bufferIndex < 0 ? e._index++ : (e._bufferIndex++, e._bufferIndex === i[e._index].length && (e._bufferIndex = -1, e._index++)), p.previous = S2;
  }
  function F(S2, w) {
    const A = w || {};
    return A.type = S2, A.start = k(), p.events.push(["enter", A, p]), l.push(A), A;
  }
  function L(S2) {
    const w = l.pop();
  ...
  function R(S2, w) {
    S2.resolveAll && !a.includes(S2) && a.push(S2), S2.resolve && en(
      p.events,
      w,
      p.events.length - w,
      S2.resolve(p.events.slice(w), p)
    ), S2.resolveTo && (p.events = S2.resolveTo(p.events, p));
  }
  function j() {
    const S2 = k(), w = p.previous, A = p.currentConstruct, U = p.events.length, G = Array.from(l);
    return {
      restore: nn,
      from: U
    };
    function nn() {
      e = S2, p.previous = w, p.currentConstruct = A, p.events.length = U, l = G, V();
    }
  }
  function V() {
...
var gr = Object.freeze(Object.defineProperty({
  __proto__: null,
  attentionMarkers: fr,
  contentInitial: or,
  disable: xr,
...
var yr = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;
function Sr(n) {
  ...
  function(n, r, t) {
    return typeof r != "string" && (t = r, r = void 0), wr(t)(
      br(
        ...
        kr(t).document().write(dr()(n, r, true))
      )
    );
  }
);
function wr(n) {
  ...
  function u(m, b, E) {
    let z = b - 1, I = -1, X = false, ln, rn, gn, kn;
    for (; ++z <= E; ) {
      const M = m[z];
      if (M[1].type === "listUnordered" || M[1].type === "listOrdered" || M[1].type === "blockQuote" ? (M[0] === "enter" ? I++ : I--, kn = void 0) : M[1].type === "lineEndingBlank" ? M[0] === "enter" && (ln && !kn && !I && !gn && (gn = z), kn = void 0) : M[1].type === "linePrefix" || M[1].type === "listItemValue" || M[1].type === "listItemMarker" || M[1].type === "listItemPrefix" || M[1].type === "listItemPrefixWhitespace" || (kn = void 0), !I && M[0] === "enter" && M[1].type === "listItemPrefix" || I === -1 && M[0] === "exit" && (M[1].type === "listUnordered" || M[1].type === "listOrdered")) {
        if (ln) {
          ...
          for (rn = void 0; wn--; ) {
            ...
            if (un[1].type === "lineEnding" || un[1].type === "lineEndingBlank") {
              if (un[0] === "exit")
                continue;
              rn && (m[rn][1].type = "lineEndingBlank", X = true), un[1].type = "lineEnding", rn = wn;
          ...
          gn && (!rn || gn < rn) && (ln._spread = true), ln.end = Object.assign(
            {},
        ...
        }, m.splice(z, 0, ["enter", ln, M[2]]), z++, E++, gn = void 0, kn = true);
      }
    }
  ...
  function f() {
    a("expectingFirstListItemValue", true);
  }
  function k(m) {
  ...
  function y() {
    i("flowCodeInside") || (this.buffer(), a("flowCodeInside", true));
  }
  function _() {
    const m = this.resume(), b = this.stack[this.stack.length - 1];
  ...
  function R() {
    a("setextHeadingSlurpLineEnding", true);
  }
  function j(m) {
    const b = this.stack[this.stack.length - 1];
  ...
  function A(m) {
    ...
    !i("setextHeadingSlurpLineEnding") && r.canContainEols.includes(b.type) && (S2.call(this, m), w.call(this, m));
  }
  function U() {
    a("atHardBreak", true);
  }
  ...
  function s() {
    ...
    if (a("inReference", true), E.type === "link") {
      const z = m.children;
      E.children = z;
    } else
      E.alt = b;
...
var Or = (n, r = "", {
  ...
  isTitle: e = false,
  classes: u = "",
  useHtmlLabels: a = true,
  isNode: i = true,
  width: l,
  addSvgBackground: c = false
} = {}) => {
  if (S.info("createText", r, t, e, u, a, i, c), a) {
    const p = zr(r), h = {
      isNode: i,
      label: rx(p).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
//# sourceMappingURL=chunk-UIMDGI6T.js.map
