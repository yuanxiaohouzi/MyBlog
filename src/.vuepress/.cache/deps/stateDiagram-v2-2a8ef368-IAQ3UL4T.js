...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/stateDiagram-v2-2a8ef368.js
var h = "rect";
var C = "rectWithTitle";
var nt = "start";
var ct = "end";
...
var A2 = (t, n, e, c, i, r) => {
  ...
  if (s !== "root") {
    ...
    e.start === true && (T = nt), e.start === false && (T = ct), e.type !== xt && (T = e.type), y[s] || (y[s] = {
      id: s,
      shape: T,
      description: Fn.sanitizeText(s, Ut()),
      classes: `${_} ${Et}`
    });
    const o = y[s];
    e.description && (Array.isArray(o.description) ? (o.shape = C, o.description.push(e.description)) : o.description.length > 0 ? (o.shape = C, o.description === s ? o.description = [e.description] : o.description = [o.description, e.description]) : (o.shape = h, o.description = e.description), o.description = Fn.sanitizeTextOrArray(o.description, Ut())), o.description.length === 1 && o.shape === C && (o.shape = h), !o.type && e.doc && (S.info("Setting cluster for ", s, G(e)), o.type = "group", o.dir = G(e), o.shape = e.type === re ? it : rt, o.classes = o.classes + " " + ft + " " + (r ? bt : ""));
    const p = {
      labelStyle: "",
      shape: o.shape,
      ...
      case Rt:
        {
          ...
          const _ = {
            ...
            style: W,
            labelStyle: "",
            label: Fn.sanitizeText(s.description, Ut()),
            arrowheadStyle: z,
            labelpos: m,
            labelType: q,
            thickness: K,
...
//# sourceMappingURL=stateDiagram-v2-2a8ef368-IAQ3UL4T.js.map
