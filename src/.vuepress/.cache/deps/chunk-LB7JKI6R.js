...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/edges-8c2fb38e.js
var st = (r, t, e, n) => {
  t.forEach((a) => {
    yt[a](r, e, n);
  });
...
var S3 = async (r, t, e, n) => {
  ...
  const o = l.node();
  let h;
  t.labelType === "markdown" ? h = Or(l, Je(rx(c), Ut()), {
    useHtmlLabels: s,
          ...
          (g) => new Promise(
            (R) => g.addEventListener("load", function() {
              if (g.style.display = "flex", g.style.flexDirection = "column", u) {
                const I = Ut().fontSize ? Ut().fontSize : window.getComputedStyle(document.body).fontSize, E = 5;
...
var St = async (r, t) => {
  ...
  const { shapeSvg: n, bbox: a, halfPadding: s } = await S3(
    r,
    t,
    "node " + t.classes,
    true
...
var Et = St;
var q = async (r, t) => {
  const { shapeSvg: e, bbox: n } = await S3(r, t, void 0, true), a = n.width + t.padding, s = n.height + t.padding, i = a + s, l = [
    { x: i / 2, y: 0 },
    { x: i, y: -i / 2 },
    { x: i / 2, y: -i },
    { x: 0, y: -i / 2 }
...
var Mt = async (r, t) => {
  const { shapeSvg: e, bbox: n } = await S3(r, t, void 0, true), a = 4, s = n.height + t.padding, i = s / a, l = n.width + 2 * i + t.padding, c = [
    { x: i, y: 0 },
    { x: l - i, y: 0 },
    { x: l, y: -s / 2 },
    { x: l - i, y: -s },
...
var Ct = async (r, t) => {
  const { shapeSvg: e, bbox: n } = await S3(r, t, void 0, true), a = n.width + t.padding, s = n.height + t.padding, i = [
    { x: -s / 2, y: 0 },
    { x: a, y: 0 },
    { x: a, y: -s },
    { x: -s / 2, y: -s },
...
var _t = async (r, t) => {
  const { shapeSvg: e, bbox: n } = await S3(r, t, void 0, true), a = n.width + t.padding, s = a / 2, i = s / (2.5 + a / 50), l = n.height + i + t.padding, c = "M 0," + i + " a " + s + "," + i + " 0,0,0 " + a + " 0 a " + s + "," + i + " 0,0,0 " + -a + " 0 l 0," + l + " a " + s + "," + i + " 0,0,0 " + a + " 0 l 0," + -l, o = e.attr("label-offset-y", i).insert("path", ":first-child").attr("style", t.style).attr("d", c).attr("transform", "translate(" + -a / 2 + "," + -(l / 2 + i) + ")");
...
var $t = async (r, t) => {
  const { shapeSvg: e, bbox: n, halfPadding: a } = await S3(
    r,
    t,
    "node " + t.classes,
    true
...
var Wt = async (r, t) => {
  const { shapeSvg: e } = await S3(r, t, "label", true);
...
var Yt = async (r, t) => {
  const { shapeSvg: e, bbox: n } = await S3(r, t, void 0, true), a = n.height + t.padding, s = n.width + a / 4 + t.padding, i = e.insert("rect", ":first-child").attr("style", t.style).attr("rx", a / 2).attr("ry", a / 2).attr("x", -s / 2).attr("y", -a / 2).attr("width", s).attr("height", a);
  return k(t, i), t.intersect = function(l) {
    return m.rect(t, l);
  }, e;
};
var Dt = async (r, t) => {
  const { shapeSvg: e, bbox: n, halfPadding: a } = await S3(r, t, void 0, true), s = e.insert("circle", ":first-child");
  return s.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + a).attr("width", n.width + t.padding).attr("height", n.height + t.padding), S2.info("Circle main"), k(t, s), t.intersect = function(i) {
    return S2.info("Circle intersect", t, n.width / 2 + a, i), m.circle(t, n.width / 2 + a, i);
  }, e;
};
var Ut2 = async (r, t) => {
  const { shapeSvg: e, bbox: n, halfPadding: a } = await S3(r, t, void 0, true), s = 5, i = e.insert("g", ":first-child"), l = i.insert("circle"), c = i.insert("circle");
  return l.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + a + s).attr("width", n.width + t.padding + s * 2).attr("height", n.height + t.padding + s * 2), c.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + a).attr("width", n.width + t.padding).attr("height", n.height + t.padding), S2.info("DoubleCircle main"), k(t, l), t.intersect = function(o) {
...
var zt = (r, t) => {
  ...
  let d = 0;
  const p = t.classData.annotations && t.classData.annotations[0], y = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", u = b.node().appendChild(T(y, t.labelStyle, true, true));
  let g = u.getBBox();
  if (ia(Ut().flowchart.htmlLabels)) {
    const B = u.children[0], M2 = At(u);
  ...
  t.classData.type !== void 0 && t.classData.type !== "" && (Ut().flowchart.htmlLabels ? R += "&lt;" + t.classData.type + "&gt;" : R += "<" + t.classData.type + ">");
  const I = b.node().appendChild(T(R, t.labelStyle, true, true));
  At(I).attr("class", "classTitle");
  let E = I.getBBox();
  if (ia(Ut().flowchart.htmlLabels)) {
    const B = I.children[0], M2 = At(I);
  ...
  t.classData.members.forEach((B) => {
    const M2 = M(B);
    let $ = M2.displayText;
    Ut().flowchart.htmlLabels && ($ = $.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
...
var er = (r, t) => {
  const e = ia(Ut().flowchart.htmlLabels), n = t.labelType === "markdown" ? Or(r, t.label, {
    style: t.labelStyle,
    useHtmlLabels: e,
...
var sr = (r, t) => {
  S2.info("Moving label abc78 ", r.id, r.label, j[r.id]);
...
var Ft = (r, t, e) => {
  ...
  if (Math.abs(a - t.y) * i > Math.abs(n - t.x) * c) {
    ...
    return l === 0 && (b.x = t.x, b.y = t.y), h === 0 && (b.x = t.x), o === 0 && (b.y = t.y), S2.warn(`abc89 topp/bott calc, Q ${o}, q ${f}, R ${h}, r ${l}`, b), b;
  } else {
    e.x < t.x ? l = t.x - i - n : l = n - i - t.x;
    let f = o * l / h, b = e.x < t.x ? e.x + h - l : e.x - h + l, d = e.y < t.y ? e.y + f : e.y - f;
    return S2.warn(`sides calc abc89, Q ${o}, q ${f}, R ${h}, r ${l}`, { _x: b, _y: d }), l === 0 && (b = t.x, d = t.y), h === 0 && (b = t.x), o === 0 && (d = t.y), { x: b, y: d };
  }
};
var G = (r, t) => {
...
var ir = function(r, t, e, n, a, s) {
  ...
  let f;
  a === "graph" || a === "flowchart" ? f = e.curve || mf : f = mf;
  const b = S().x(function(g) {
    return g.x;
  }).y(function(g) {
    return g.y;
  }).curve(f);
...
//# sourceMappingURL=chunk-LB7JKI6R.js.map
