...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/mindmap-definition-825812a2.js
var Ki = function() {
  var he = function(j, Y, te, L) {
    for (te = te || {}, L = j.length; L--; te[j[L]] = Y)
      ;
    return te;
  }, fe = [1, 4], ee = [1, 13], ve = [1, 12], H = [1, 15], O = [1, 16], T = [1, 20], x = [1, 19], S2 = [6, 7, 8], G = [1, 26], U = [1, 24], P = [1, 25], K = [6, 7, 11], D = [1, 6, 13, 15, 16, 19, 22], V = [1, 33], _ = [1, 34], Q = [1, 6, 7, 11, 13, 15, 16, 19, 22], ne = {
    trace: function() {
    },
    yy: {},
...
var Op = (he, fe) => {
  switch (S.debug("In get type", he, fe), he) {
    case "[":
      return yt.RECT;
    case "(":
...
var Up = function(he, fe, ee, ve) {
  ...
  const S2 = T.append("g"), G = T.append("g"), U = fe.descr.replace(/(<br\/*>)/g, `
`);
  Or(G, U, {
    useHtmlLabels: H,
    width: fe.width,
  ...
  switch (fe.type) {
    ...
    case yt.RECT:
      ...
      break;
    case yt.CIRCLE:
      S2.attr("transform", "translate(" + fe.width / 2 + ", " + +fe.height / 2 + ")"), Gp(S2, fe);
      break;
    case yt.CLOUD:
      Fp(S2, fe);
      break;
...
var Yp = function(fe, ee, ve, H, O) {
  const T = O % (Xu - 1), x = ve.x + ve.width / 2, S2 = ve.y + ve.height / 2, G = ee.x + ee.width / 2, U = ee.y + ee.height / 2, P = G > x ? x + Math.abs(x - G) / 2 : x - Math.abs(x - G) / 2, K = U > S2 ? S2 + Math.abs(S2 - U) / 2 : S2 - Math.abs(S2 - U) / 2, D = G > x ? Math.abs(x - P) / 2 + x : -Math.abs(x - P) / 2 + x, V = U > S2 ? Math.abs(S2 - K) / 2 + S2 : -Math.abs(S2 - K) / 2 + S2;
  fe.append("path").attr(
    "d",
    ve.direction === "TB" || ve.direction === "BT" ? `M${x},${S2} Q${x},${V} ${P},${K} T${G},${U}` : `M${x},${S2} Q${D},${S2} ${P},${K} T${G},${U}`
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var Rr = nl, Sa = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof Pl < "u" ? Pl : typeof self < "u" ? self : {};
    function il(t, e) {
    ...
    var Aa = Il, ss = 0 / 0, Rl = /^[-+]0x[0-9a-f]+$/i, kl = /^0b[01]+$/i, Pl2 = /^0o[0-7]+$/i, Bl = parseInt;
    function Fl(t) {
      if (typeof t == "number")
        return t;
      if (Aa(t))
      ...
      t = pl(t);
      var r = kl.test(t);
      return r || Pl2.test(t) ? Bl(t.slice(2), r ? 2 : 8) : Rl.test(t) ? ss : +t;
    }
    ...
    function Vl(t, e, r) {
      ...
      function v(A2) {
        var w = a, I = n;
        return a = n = void 0, u = A2, s = t.apply(I, w), s;
      }
      function d(A2) {
        return u = A2, o = setTimeout(p, e), f ? v(A2) : s;
      }
      function g(A2) {
        var w = A2 - l, I = A2 - u, C = e - w;
        return h ? $l(C, i - I) : C;
      }
      function y(A2) {
        var w = A2 - l, I = A2 - u;
      ...
      function m(A2) {
        return o = void 0, c && a ? v(A2) : (a = n = void 0, s);
      }
      function b() {
    ...
    var ln = Vl, ni = D ? D.performance : null, us = ni && ni.now ? function() {
      ...
      return e = {
        ...
        for (var o = this._private.cy, l = a = j(a) ? this.filter(a) : a, u = [], f = [], h = {}, c = {}, v = {}, d = 0, g, y = this.byGroup(), p = y.nodes, m = y.edges, b = 0; b < l.length; b++) {
          var E = l[b], M = E.id();
          E.isNode() && (u.unshift(E), e.bfs && (v[M] = true, f.push(E)), c[M] = 0);
        }
        for (var A2 = function() {
          ...
          for (var se = X.connectedEdges().filter(function(ye) {
            ...
            Te.length !== 0 && !v[Ee] && (Te = Te[0], u.push(Te), e.bfs && (v[Ee] = true, f.push(Te)), h[Ee] = we, c[Ee] = c[z] + 1);
          }
        }; u.length !== 0; ) {
          var w = A2();
    ...
    var tf = il(function(t, e) {
      (function() {
        ...
        n = Math.floor, h = Math.min, a = function(p, m) {
          ...
          for (E == null && (E = p.length); b < E; )
            A2 = n((b + E) / 2), M(m, p[A2]) < 0 ? E = A2 : b = A2 + 1;
          ...
          var b, E, M, A2, w, I;
          for (m == null && (m = a), A2 = function() {
            I = [];
            for (var C = 0, B = n(p.length / 2); 0 <= B ? C < B : C > B; 0 <= B ? C++ : C--)
              I.push(C);
            return I;
          }.apply(this).reverse(), w = [], E = 0, M = A2.length; E < M; E++)
            b = A2[E], w.push(y(p, b, m));
          return w;
        }, d = function(p, m, b) {
          var E;
          ...
          if (b == null && (b = a), M = p.slice(0, m), !M.length)
            return M;
          for (i(M, b), I = p.slice(m), A2 = 0, w = I.length; A2 < w; A2++)
            E = I[A2], l(M, E, b);
          return M.sort(b).reverse();
        }, v = function(p, m, b) {
          var E, M, A2, w, I, C, B, F2, R;
          if (b == null && (b = a), m * 10 <= p.length) {
            if (A2 = p.slice(0, m).sort(b), !A2.length)
              return A2;
            for (M = A2[A2.length - 1], B = p.slice(m), w = 0, C = B.length; w < C; w++)
              E = B[w], b(E, M) < 0 && (f(A2, E, 0, null, b), A2.pop(), M = A2[A2.length - 1]);
            return A2;
          }
          for (i(p, b), R = [], I = 0, F2 = h(m, p.length); 0 <= F2 ? I < F2 : I > F2; 0 <= F2 ? ++I : --I)
            R.push(s(p, b));
          return R;
        }, g = function(p, m, b, E) {
          var M, A2, w;
          for (E == null && (E = a), M = p[b]; b > m; ) {
            if (w = b - 1 >> 1, A2 = p[w], E(M, A2) < 0) {
              p[b] = A2, b = w;
              continue;
            }
            break;
          ...
          var E, M, A2, w, I;
          for (b == null && (b = a), M = p.length, I = m, A2 = p[m], E = 2 * m + 1; E < M; )
            w = E + 1, w < M && !(b(p[E], p[w]) < 0) && (E = w), p[m] = p[E], m = E, E = 2 * m + 1;
          return p[m] = A2, g(p, I, m, b);
        }, r = function() {
      ...
      dijkstra: function(e) {
        ...
        for (var M = function(W, Z) {
          ...
          var A2 = m.pop(), w = y(A2), I = A2.id();
          if (c[I] = w, w !== 1 / 0)
            for (var C = A2.neighborhood().intersect(d), B = 0; B < C.length; B++) {
              var F2 = C[B], R = F2.id(), X = M(A2, F2), z = w + X.dist;
              z < y(F2) && (p(F2, z), h[R] = {
                node: A2,
                edge: X.edge
              });
      ...
      aStar: function(e) {
        ...
        for (var w = 0; d.size() > 0; ) {
          if (M(), w++, E === f) {
            for (var I = [], C = i, B = f, F2 = p[B]; I.unshift(C), F2 != null && I.unshift(F2), C = y[B], C != null; )
              B = C.id(), F2 = p[B];
            return {
              found: true,
              distance: h[E],
      ...
      floydWarshall: function(e) {
        ...
        for (var m = new Array(h), b = new Array(h), E = 0; E < u.length; E++) {
          var M = u[E], A2 = M.source()[0], w = M.target()[0];
          if (A2 !== w) {
            var I = c(A2), C = c(w), B = I * f + C, F2 = s(M);
            if (d[B] > F2 && (d[B] = F2, m[B] = C, b[B] = M), !i) {
              var R = C * f + I;
              !i && d[R] > F2 && (d[R] = F2, m[R] = I, b[R] = M);
            }
          }
        }
        for (var X = 0; X < f; X++)
      ...
      bellmanFord: function(e) {
        var r = this, a = ff(e), n = a.weight, i = a.directed, s = a.root, o = n, l = this, u = this.cy(), f = this.byGroup(), h = f.edges, c = f.nodes, v = c.length, d = new ur(), g = false, y = [];
      ...
      kargerStein: function() {
        ...
        for (var c = 1 / 0, v = [], d = new Array(i), g = new Array(i), y = new Array(i), p = function(oe, ge) {
          ...
          p(g, y);
          var A2 = ui(g, E, l, 2), w = ui(y, M, l, 2);
          A2.length <= w.length && A2.length < c ? (c = A2.length, v = A2, p(g, d)) : w.length <= A2.length && w.length < c && (c = w.length, v = w, p(y, d));
        }
        for (var I = this.spawn(v.map(function(ie) {
          return n[ie[0]];
        })), C = this.spawn(), B = this.spawn(), F2 = d[0], R = 0; R < d.length; R++) {
          var X = d[R], z = a[R];
          X === F2 ? C.merge(z) : B.merge(z);
        }
        var re = function(oe) {
          var ge = e.spawn();
      ...
      var l = Fa(i, s), u = i / 2, f = s / 2, h;
      {
        ...
        if (h = Tr(e, r, a, n, c, v, d, g, false), h.length > 0)
          return h;
      }
      {
      ...
      {
        var E = a - u + l - o, M = n + f + o, A2 = a + u - l + o, w = M;
        if (h = Tr(e, r, a, n, E, M, A2, w, false), h.length > 0)
          return h;
      }
      {
        var I = a - u - o, C = n - f + l - o, B = I, F2 = n + f - l + o;
        if (h = Tr(e, r, a, n, I, C, B, F2, false), h.length > 0)
          return h;
      }
      var R;
      {
      ...
      for (var l = new Array(a.length), u = s / 2, f = o / 2, h = di(s, o), c = h * h, v = 0; v < a.length / 4; v++) {
        ...
        var y = n + u * a[v * 4], p = i + f * a[v * 4 + 1], m = -a[d] * a[g] - a[d + 1] * a[g + 1], b = h / Math.tan(Math.acos(m) / 2), E = y - b * a[d], M = p - b * a[d + 1], A2 = y + b * a[g], w = p + b * a[g + 1];
        l[v * 4] = E, l[v * 4 + 1] = M, l[v * 4 + 2] = A2, l[v * 4 + 3] = w;
        var I = a[d + 1], C = -a[d], B = I * a[g] + C * a[g + 1];
        B < 0 && (I *= -1, C *= -1);
        var F2 = E + I * h, R = M + C * h, X = Math.pow(F2 - e, 2) + Math.pow(R - r, 2);
        if (X <= c)
          return true;
      }
      return Yt(e, r, l);
      ...
      if (m !== 0) {
        var b = y / m, E = p / m, M = 1e-3, A2 = 0 - M, w = 1 + M;
        return A2 <= b && b <= w && A2 <= E && E <= w ? [e + b * h, r + b * d] : u ? [e + b * h, r + b * d] : [];
      } else
      ...
      for (var u = [], f, h = new Array(a.length), c = s / 2, v = o / 2, d = di(s, o), g = 0; g < a.length / 4; g++) {
        ...
        var m = n + c * a[g * 4], b = i + v * a[g * 4 + 1], E = -a[y] * a[p] - a[y + 1] * a[p + 1], M = d / Math.tan(Math.acos(E) / 2), A2 = m - M * a[y], w = b - M * a[y + 1], I = m + M * a[p], C = b + M * a[p + 1];
        g === 0 ? (h[a.length - 2] = A2, h[a.length - 1] = w) : (h[g * 4 - 2] = A2, h[g * 4 - 1] = w), h[g * 4] = I, h[g * 4 + 1] = C;
        var B = a[y + 1], F2 = -a[y], R = B * a[p] + F2 * a[p + 1];
        R < 0 && (B *= -1, F2 *= -1);
        var X = A2 + B * d, z = w + F2 * d;
      ...
      pageRank: function(e) {
        ...
        for (var E = 0; E < v; E++) {
          var M = f[E], A2 = M.data("source"), w = M.data("target");
          if (A2 !== w) {
            var I = u.indexOfId(A2), C = u.indexOfId(w), B = s(M), F2 = C * h + I;
            d[F2] += B, g[I] += B;
          }
        }
      ...
      degreeCentrality: function(e) {
        ...
        if (i = r.collection(i)[0], o) {
          for (var v = i.connectedEdges(), d = v.filter(function(A2) {
            return A2.target().same(i) && a.has(A2);
          }), g = v.filter(function(A2) {
            return A2.source().same(i) && a.has(A2);
    ...
    var $f = Lt({
      ...
      betweennessCentrality: function(e) {
        ...
        for (var g = function(b) {
          for (var E = o[b].id(), M = [], A2 = {}, w = {}, I = {}, C = new Ra(function(Ee, ye) {
            return I[Ee] - I[ye];
          }), B = 0; B < o.length; B++) {
            var F2 = o[B].id();
            A2[F2] = [], w[F2] = 0, I[F2] = 1 / 0;
          }
          for (w[E] = 1, I[E] = 0, C.push(E); !C.empty(); ) {
            ...
            if (M.push(R), i)
              for (var X = 0; X < l[R].length; X++) {
                ...
                var Z = n(W);
                z = z.id(), I[z] > I[R] + Z && (I[z] = I[R] + Z, C.nodes.indexOf(z) < 0 ? C.push(z) : C.updateItem(z), w[z] = 0, A2[z] = []), I[z] == I[R] + Z && (w[z] = w[z] + w[R], A2[z].push(R));
              }
            else
              for (var ie = 0; ie < l[R].length; ie++) {
                var oe = l[R][ie].id();
                I[oe] == 1 / 0 && (C.push(oe), I[oe] = I[R] + 1), I[oe] == I[R] + 1 && (w[oe] = w[oe] + w[R], A2[oe].push(R));
              }
          }
          for (var ge = {}, se = 0; se < o.length; se++)
            ge[o[se].id()] = 0;
          for (; M.length > 0; ) {
            for (var de = M.pop(), we = 0; we < A2[de].length; we++) {
              var Te = A2[de][we];
    ...
    var rh = Lt({
        ...
        for (var c = 0; c < i.k; c++) {
          ...
          if (v.length !== 0) {
            for (var d = i.attributes.length, g = l[c], y = new Array(d), p = new Array(d), m = 0; m < d; m++) {
              ...
              y[m] = p[m] / v.length, ah(y[m], g[m], i.sensitivityThreshold) || (u = true);
            }
      ...
      for (var m = true, b = 0; m && b < n.maxIterations; )
        m = false, uh(s, a, o, u, n), lh(o, l, s, a, n), nh(o, l, n.sensitivityThreshold) || (m = true), b++;
      return i = fh(a, o, n, r), {
        clusters: i,
      ...
      for (var s = 0, o = 1 / 0, l, u = i.attributes, f = function(C, B) {
        return mn(i.distance, u.length, function(F2) {
          return u[F2](C);
        }, function(F2) {
          return u[F2](B);
        }, C, B);
      ...
      for (var b = 0; b < e.length; b++) {
        ...
        if (n[E] === d.key || n[E] === g.key) {
          for (var M = E, A2 = 0; A2 < e.length; A2++) {
            var w = e[A2].key;
            a[E][w] < a[E][M] && (M = w);
          }
          n[E] = M;
      ...
      for (var m = 0; m < l; m++)
        c[m] = 0;
      for (var b = new Array(o), E = new Array(o), M = new Array(o), A2 = 0; A2 < o; A2++)
        b[A2] = 0, E[A2] = 0, M[A2] = 0;
      for (var w = new Array(o * n.minIterations), I = 0; I < w.length; I++)
        w[I] = 0;
      var C;
      for (C = 0; C < n.maxIterations; C++) {
        for (var B = 0; B < o; B++) {
          for (var F2 = -1 / 0, R = -1 / 0, X = -1, z = 0, re = 0; re < o; re++)
            b[re] = h[B * o + re], z = c[B * o + re] + u[B * o + re], z >= F2 ? (R = F2, F2 = z, X = re) : z > R && (R = z);
          for (var W = 0; W < o; W++)
            h[B * o + W] = (1 - n.damping) * (u[B * o + W] - F2) + n.damping * b[W];
      ...
      hierholzer: function(e) {
        ...
        i ? s.forEach(function(m) {
          var b = m.id();
          if (m.isNode()) {
            var E = m.indegree(true), M = m.outdegree(true), A2 = E - M, w = M - E;
            A2 == 1 ? l ? o = true : l = b : w == 1 ? u ? o = true : u = b : (w > 1 || A2 > 1) && (o = true), h[b] = [], m.outgoers().forEach(function(I) {
        ...
        if (u && l)
          ...
          f || (f = s[0].id());
        var d = function(b) {
          for (var E = b, M = [b], A2, w, I; h[E].length; )
            A2 = h[E].shift(), w = c[A2][0], I = c[A2][1], E != I ? (h[I] = h[I].filter(function(C) {
              return C != A2;
            }), E = I) : !i && E != w && (h[w] = h[w].filter(function(C) {
              return C != A2;
            }), E = w), M.unshift(A2), M.unshift(E);
          return M;
        }, g = [], y = [];
        ...
        for (var p in h)
          if (h[p].length)
            return v;
        return v.found = true, v.trail = this.spawn(g, true), v;
      }
    }, wn = function() {
      var e = this, r = {}, a = 0, n = 0, i = [], s = [], o = {}, l = function(c, v) {
        ...
        g.push(s.pop().edge), g.forEach(function(p) {
          ...
          y.merge(p), m.forEach(function(b) {
            ...
            y.merge(b), r[E].cutVertex ? y.merge(M.filter(function(A2) {
              return A2.isLoop();
            })) : y.merge(M);
          });
        }), i.push(y);
        ...
        if (g.size() === 0)
          ...
          g.forEach(function(E) {
            y = E.source().id(), p = E.target().id(), m = y === v ? p : y, m !== d && (b = E.id(), o[b] || (o[b] = true, s.push({
              x: v,
              y: m,
              edge: E
            })), m in r ? r[v].low = Math.min(r[v].low, r[m].id) : (h(c, m, v), r[v].low = Math.min(r[v].low, r[m].low), r[v].id <= r[m].low && (r[v].cutVertex = true, l(v, m))));
          });
        }
      };
          ...
          if (j(n)) {
            ...
            for (var y = 0, p = l.length; y < p; y++)
              for (var m = l[y]._private[i.field], b = Object.keys(m), E = 0; E < b.length; E++) {
                var M = b[E], A2 = !i.immutableKeys[M];
                A2 && (m[M] = void 0);
              }
            i.triggerEvent && s[i.triggerFnName](i.event);
          }
      ...
      toggleClass: function(e, r) {
        ...
        for (var a = this, n = r === void 0, i = [], s = 0, o = a.length; s < o; s++)
          for (var l = a[s], u = l._private.classes, f = false, h = 0; h < e.length; h++) {
            var c = e[h], v = u.has(c), d = false;
            r || n && !v ? (u.add(c), d = true) : (!r || n && v) && (u.delete(c), d = true), !f && d && (i.push(l), f = true);
          }
    ...
    var Yv = function(e) {
      ...
      for (var e = function(f) {
        ...
        switch (c) {
          ...
          case Be.COMPOUND_SPLIT: {
            var A2 = i(f.left, h), w = i(f.subject, h), I = i(f.right, h);
            return A2 + (A2.length > 0 ? " " : "") + w + I;
          }
          case Be.TRUE:
            return "";
        }
      ...
      var n, i = j(e), s = k(e), o = j(a), l, u, f = false, h = false, c = false;
    ...
    ca = Ar = {}, Ar.renderedBoundingBox = function(t) {
      ...
      function r(s) {
        ...
        function v(C, B, F2) {
          var R = 0, X = 0, z = B + F2;
          return C > 0 && z > 0 && (R = B / z * C, X = F2 / z * C), {
            biasDiff: R,
        ...
        function d(C, B, F2, R) {
          if (F2.units === "%")
            switch (R) {
              case "width":
                return C > 0 ? F2.pfValue * C : 0;
              case "height":
                return B > 0 ? F2.pfValue * B : 0;
              case "average":
                return C > 0 && B > 0 ? F2.pfValue * (C + B) / 2 : 0;
              case "min":
                return C > 0 && B > 0 ? C > B ? F2.pfValue * B : F2.pfValue * C : 0;
              case "max":
                return C > 0 && B > 0 ? C > B ? F2.pfValue * C : F2.pfValue * B : 0;
              default:
                return 0;
            }
          else
            return F2.units === "px" ? F2.pfValue : 0;
        }
        ...
        var b = v(f.width.val - h.w, g, y), E = b.biasDiff, M = b.biasComplementDiff, A2 = v(f.height.val - h.h, p, m), w = A2.biasDiff, I = A2.biasComplementDiff;
    ...
    var Zt = function(e) {
      ...
      if (!r.cy().headless()) {
        ...
        if (o) {
          var l = r.pstyle("text-halign"), u = r.pstyle("text-valign"), f = Va(s, "labelWidth", a), h = Va(s, "labelHeight", a), c = Va(s, "labelX", a), v = Va(s, "labelY", a), d = r.pstyle(n + "text-margin-x").pfValue, g = r.pstyle(n + "text-margin-y").pfValue, y = r.isEdge(), p = r.pstyle(n + "text-rotation"), m = r.pstyle("text-outline-width").pfValue, b = r.pstyle("text-border-width").pfValue, E = b / 2, M = r.pstyle("text-background-padding").pfValue, A2 = 2, w = h, I = f, C = I / 2, B = w / 2, F2, R, X, z;
          if (y)
            F2 = c - C, R = c + C, X = v - B, z = v + B;
          else {
            switch (l.value) {
              case "left":
                F2 = c - I, R = c;
          ...
          F2 += d - Math.max(m, E) - M - A2, R += d + Math.max(m, E) + M + A2, X += g - Math.max(m, E) - M - A2, z += g + Math.max(m, E) + M + A2;
          var re = a || "main", W = i.labelBounds, Z = W[re] = W[re] || {};
          Z.x1 = F2, Z.y1 = X, Z.x2 = R, Z.y2 = z, Z.w = R - F2, Z.h = z - X;
          var ie = y && p.strValue === "autorotate", oe = p.pfValue != null && p.pfValue !== 0;
          if (ie || oe) {
            var ge = ie ? Va(i.rstyle, "labelAngle", a) : p.pfValue, se = Math.cos(ge), de = Math.sin(ge), we = (F2 + R) / 2, Te = (X + z) / 2;
            if (!y) {
              switch (l.value) {
                case "left":
                  we = R;
            ...
            }, ye = Ee(F2, X), ae = Ee(F2, z), xe = Ee(R, X), Ce = Ee(R, z);
            F2 = Math.min(ye.x, ae.x, xe.x, Ce.x), R = Math.max(ye.x, ae.x, xe.x, Ce.x), X = Math.min(ye.y, ae.y, xe.y, Ce.y), z = Math.max(ye.y, ae.y, xe.y, Ce.y);
          }
          var Oe = re + "Rot", Ie = W[Oe] = W[Oe] || {};
          Ie.x1 = F2, Ie.y1 = X, Ie.x2 = R, Ie.y2 = z, Ie.w = R - F2, Ie.h = z - X, rr(e, F2, X, R, z), rr(i.labelBounds.all, F2, X, R, z);
        }
        return e;
      }
    }, nd = function(e, r) {
      var a = e._private.cy, n = a.styleEnabled(), i = a.headless(), s = Ut2(), o = e._private, l = e.isNode(), u = e.isEdge(), f, h, c, v, d, g, y = o.rstyle, p = l && n ? e.pstyle("bounds-expansion").pfValue : [0], m = function(Ve) {
      ...
      if (b) {
        ...
        var A2 = 0, w = 0;
        n && r.includeUnderlays && (A2 = e.pstyle("underlay-opacity").value, A2 !== 0 && (w = e.pstyle("underlay-padding").value));
        ...
        Re.all != null ? Cf(Re.all) : Re.all = Ut2(), n && r.includeLabels && (r.includeMainLabels && Oi(s, e, null), u && (r.includeSourceLabels && Oi(s, e, "source"), r.includeTargetLabels && Oi(s, e, "target")));
      }
    ...
    var Or2 = Nn.prototype, Oo = function(e, r, a, n, i, s, o) {
    ...
    var Cd = Lt({
      ...
      layoutPositions: function(e, r, a) {
        var n = this.nodes().filter(function(M) {
          return !M.isParent();
        }), i = this.cy(), s = r.eles, o = function(A2) {
          return A2.id();
        }, l = nt(a, o);
        e.emit({
          type: "layoutstart",
        ...
        var u = function(A2, w, I) {
          ...
          if (!f)
            return null;
          for (var A2 = Ut2(), w = 0; w < n.length; w++) {
            var I = n[w], C = l(I, w);
            Sf(A2, C.x, C.y);
          }
          return A2;
        }, c = h(), v = nt(function(M, A2) {
          var w = l(M, A2);
          if (f) {
    ...
    At2.takesUpSpace = Pn("takesUpSpace", Mi({
      ok: va
    }));
    ...
    At2.interactive = Pn("interactive", Mi({
      ok: Dd,
      parentOk: Sd,
      edgeOkViaNode: va
    })), At2.noninteractive = function() {
      var t = this[0];
      if (t)
    ...
    At2.visible = Pn("visible", Mi({
      ...
      if (t)
        return !t.visible();
    }, At2.isBundledBezier = Pn("isBundledBezier", function() {
      return this.cy().styleEnabled() ? !this.removed() && this.pstyle("curve-style").value === "bezier" && this.takesUpSpace() : false;
    }), At2.bypass = At2.css = At2.style, At2.renderedCss = At2.renderedStyle, At2.removeBypass = At2.removeCss = At2.removeStyle, At2.pstyle = At2.parsedStyle;
    var Nr = {};
    function Po(t) {
      return function() {
        var e = arguments, r = [];
    ...
    mt.instanceString = function() {
      ...
      for (h = 0; h < o.length; h++) {
        ...
        if (v.isEdge()) {
          for (var m = v, b = ["source", "target"], E = b.length, M = false, A2 = 0; A2 < E; A2++) {
            var w = b[A2], I = g[w];
            k(I) && (I = g[w] = "" + g[w]), I == null || I === "" ? (xt("Can not create edge `" + y + "` with unspecified " + w), M = true) : a.hasElementWithId(I) || (xt("Can not create edge `" + y + "` with nonexistant " + w + " `" + I + "`"), M = true);
          }
          if (M) {
            c();
            continue;
        ...
        d.map = new ur(), d.map.set(y, {
          ele: v,
          index: 0
        }), d.removed = false, e && a.addToPool(v);
      }
      for (var F2 = 0; F2 < i.length; F2++) {
        var R = i[F2], X = R._private.data;
      ...
      for (var y = 0; y < a.length; y++) {
        ...
        if (p.isEdge()) {
          ...
          for (var E = p.parallelEdges(), M = 0; M < E.length; M++) {
            var A2 = E[M];
            v(A2), A2.isBundledBezier() && A2.dirtyBoundingBoxCache();
          }
        } else {
          var w = p.parent();
          w.length !== 0 && g(w, p);
      ...
      var F2 = new Ot(this.cy(), a);
      F2.size() > 0 && (t ? F2.emitAndNotify("remove") : e && F2.emit("remove"));
      ...
      return this;
    }, [Ys, $v, Sn, Lr, fa, rd, Ln, yd, Mo, Io, xd, In, Rn, At2, Nr, Pt].forEach(function(t) {
      Ue(mt, t);
    });
    var Od = {
      add: function(e) {
    ...
    function Nd(t, e, r, a) {
      ...
      function y(B, F2, R) {
        return ((v(F2, R) * B + d(F2, R)) * B + g(F2)) * B;
      }
      function p(B, F2, R) {
        return 3 * v(F2, R) * B * B + 2 * d(F2, R) * B + g(F2);
      }
      function m(B, F2) {
        for (var R = 0; R < n; ++R) {
          var X = p(F2, t, r);
      ...
      function E(B, F2, R) {
        var X, z, re = 0;
        do
          z = F2 + (R - F2) / 2, X = y(z, t, r) - B, X > 0 ? R = z : F2 = z;
        while (Math.abs(X) > s && ++re < o);
        return z;
      }
      function M(B) {
        for (var F2 = 0, R = 1, X = l - 1; R !== X && c[R] <= B; ++R)
          F2 += u;
        --R;
        var z = (B - c[R]) / (c[R + 1] - c[R]), re = F2 + z * u, W = p(re, t, r);
        return W >= i ? m(B, re) : W === 0 ? re : E(B, F2, F2 + u);
      }
      var A2 = false;
      function w() {
        A2 = true, (t !== e || r !== a) && b();
      ...
      var I = function(F2) {
        return A2 || w(), t === e && r === a ? F2 : F2 === 0 ? 0 : F2 === 1 ? 1 : y(M(F2), e, a);
      };
    ...
    function Id(t, e, r, a) {
      ...
      if (s.duration === 0 ? y = 1 : y = (r - l) / s.duration, s.applying && (y = s.progress), y < 0 ? y = 0 : y > 1 && (y = 1), s.delay == null) {
        ...
        var E = s.startPan, M = s.pan, A2 = i.pan, w = M != null && a;
        w && (Xa(E.x, M.x) && (A2.x = ga(E.x, M.x, y, g)), Xa(E.y, M.y) && (A2.y = ga(E.y, M.y, y, g)), t.emit("pan"));
        ...
        if (F2 && F2.length > 0 && n) {
          for (var R = 0; R < F2.length; R++) {
            var X = F2[R], z = X.name, re = X, W = s.startStyle[z], Z = f.properties[W.name], ie = ga(W, re, y, g, Z);
    ...
    function Yo(t, e) {
      ...
      function n(f, h) {
        var c = f._private, v = c.animation.current, d = c.animation.queue, g = false;
        if (v.length === 0) {
          var y = d.shift();
          y && v.push(y);
        }
        for (var p = function(A2) {
          for (var w = A2.length - 1; w >= 0; w--) {
            var I = A2[w];
            I();
          }
          ...
          if (E.stopped) {
            v.splice(m, 1), E.hooked = false, E.playing = false, E.started = false, p(E.frames);
            continue;
          }
          !E.playing && !E.applying || (E.playing && E.applying && (E.applying = false), E.started || Rd(f, b, t), Id(f, b, t, h), E.applying && (E.applying = false), p(E.frames), E.step != null && E.step(t), b.completed() && (v.splice(m, 1), E.hooked = false, E.playing = false, E.started = false, p(E.completes)), g = true);
        }
    ...
    Bt.apply = function(t) {
      ...
      for (var h = function(Oe, Ie) {
        ...
        var m = a[p], b = l[m];
        if (b != null) {
          var E = this.properties[m], M = E.type, A2 = E.groupKey, w = void 0;
          E.hashOverride != null ? w = E.hashOverride(t, b) : b.pfValue != null && (w = b.pfValue);
          var I = E.enums == null ? b.value : null, C = w != null, B = I != null, F2 = C || B, R = b.units;
          if (M.number && F2 && !M.multiple) {
            var X = C ? w : I;
            v(y(X), A2), !C && R != null && d(R, A2);
          } else
            d(b.strValue, A2);
        }
      }
      ...
      switch (a.mapped) {
        case s.mapData: {
          ...
          if (E < 0 ? E = 0 : E > 1 && (E = 1), o.color) {
            var A2 = a.valueMin[0], w = a.valueMax[0], I = a.valueMin[1], C = a.valueMax[1], B = a.valueMin[2], F2 = a.valueMax[2], R = a.valueMin[3] == null ? 1 : a.valueMin[3], X = a.valueMax[3] == null ? 1 : a.valueMax[3], z = [Math.round(A2 + (w - A2) * E), Math.round(I + (C - I) * E), Math.round(B + (F2 - B) * E), Math.round(R + (X - R) * E)];
            i = {
      ...
      if (n.length > 0 && i > 0) {
        for (var o = {}, l = false, u = 0; u < n.length; u++) {
          ...
          if (c) {
            var v = c.prev, d = v, g = c.next != null ? c.next : h, y = false, p = void 0, m = 1e-6;
    ...
    Wa.applyBypass = function(t, e, r, a) {
      ...
      for (var m = false, b = 0; b < t.length; b++) {
        for (var E = t[b], M = {}, A2 = void 0, w = 0; w < i.length; w++) {
          var I = i[w];
          if (a) {
          ...
          m = this.applyParsedProperty(E, or(I)) || m, a && (A2.next = E.pstyle(I.name));
        }
      ...
      for (var a = true, n = 0; n < t.length; n++) {
        for (var i = t[n], s = {}, o = 0; o < e.length; o++) {
          ...
          if (!(!f || !f.bypass)) {
            var h = "", c = this.parse(l, h, true), v = s[u.name] = {
              prev: f
            };
    ...
    Pi.appendFromString = function(t) {
      ...
      for (; ; ) {
        ...
        for (var g = []; ; ) {
          ...
          if (!p) {
            ft("Skipping parsing of block: Invalid formatting of style property and value definitions found in:" + v), d = true;
            break;
          }
          s = p[0];
    ...
    (function() {
      ...
      var W = Nt.properties = [].concat(g, b, y, p, m, B, d, v, f, h, c, M, A2, w, R, I, C, z, F2), Z = Nt.propertyGroups = {
        // common to all eles
        behavior: g,
        transition: b,
        visibility: y,
    ...
    Vn.parse = function(t, e, r, a) {
      ...
      if (u.multiple && a !== "multiple") {
        ...
        if (l ? b = e.split(/\s+/) : te(e) ? b = e : b = [e], u.evenMultiple && b.length % 2 !== 0)
          return null;
        for (var E = [], M = [], A2 = [], w = "", I = false, C = 0; C < b.length; C++) {
          var B = n.parse(t, b[C], r, "multiple");
          I = I || j(B.value), E.push(B.value), A2.push(B.pfValue != null ? B.pfValue : B.value), M.push(B.units), w += (C > 0 ? " " : "") + B.strValue;
        }
    ...
    var Gd = {
      ...
      getZoomedViewport: function(e) {
        ...
        if (r.zoomingEnabled || (o = true), k(e) ? s = e : L(e) && (s = e.level, e.position != null ? i = dn(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !r.panningEnabled && (o = true)), s = s > r.maxZoom ? r.maxZoom : s, s = s < r.minZoom ? r.minZoom : s, o || !k(s) || s === n || i != null && (!k(i.x) || !k(i.y)))
          return null;
        if (i != null) {
          var l = a, u = n, f = s, h = {
            x: -f / u * (i.x - l.x) + i.x,
    ...
    var Za = function(e) {
      ...
      f([o.style, o.elements], function(v) {
        ...
        u.styleEnabled && r.style().append(d), c(g, function() {
          r.startAnimationLoop(), u.ready = true, Y(o.ready) && r.on("ready", o.ready);
        ...
        if (L(e)) {
          if (r.startBatch(), e.elements) {
            var s = {}, o = function(E, M) {
              for (var A2 = [], w = [], I = 0; I < E.length; I++) {
                var C = E[I];
                if (!C.data.id) {
                  ft("cy.json() cannot handle elements without an ID attribute");
                  continue;
                }
                var B = "" + C.data.id, F2 = r.getElementById(B);
                s[B] = true, F2.length !== 0 ? w.push({
                  ele: F2,
                  json: C
                }) : (M && (C.group = M), A2.push(C));
              }
              r.add(A2);
    ...
    qo.prototype.run = function() {
      var t = this.options, e = t, r = t.cy, a = e.eles, n = a.nodes().filter(function(Re) {
        return !Re.isParent();
      }), i = a, s = e.directed, o = e.maximal || e.maximalAdjustments > 0, l = Ut2(e.boundingBox ? e.boundingBox : {
        x1: 0,
        y1: 0,
        w: r.width(),
        h: r.height()
    ...
    Wo.prototype.run = function() {
      ...
      for (var s = Ut2(e.boundingBox ? e.boundingBox : {
        x1: 0,
        y1: 0,
        w: r.width(),
        h: r.height()
      ...
      var E = function(A2, w) {
        var I = e.startAngle + w * u * (n ? 1 : -1), C = f * Math.cos(I), B = f * Math.sin(I), F2 = {
          x: o.x + C,
          y: o.y + B
        };
        return F2;
    ...
    Ko.prototype.run = function() {
      for (var t = this.options, e = t, r = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise, a = t.cy, n = e.eles, i = n.nodes().not(":parent"), s = Ut2(e.boundingBox ? e.boundingBox : {
        x1: 0,
        y1: 0,
        w: a.width(),
        h: a.height()
      ...
      var A2 = u + e.minNodeSpacing;
      if (!e.avoidOverlap) {
        var w = p.length > 0 && p[0].length > 1, I = Math.min(s.w, s.h) / 2 - A2, C = I / (p.length + w ? 1 : 0);
        A2 = Math.min(A2, C);
      }
      for (var B = 0, F2 = 0; F2 < p.length; F2++) {
        var R = p[F2], X = e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / R.length : e.sweep, z = R.dTheta = X / Math.max(1, R.length - 1);
        if (R.length > 1 && e.avoidOverlap) {
          var re = Math.cos(z) - Math.cos(0), W = Math.sin(z) - Math.sin(0), Z = Math.sqrt(A2 * A2 / (re * re + W * W));
          B = Math.max(Z, B);
        }
        R.r = B, B += A2;
      }
    ...
    var Hd = function(e, r, a) {
      for (var n = a.eles.edges(), i = a.eles.nodes(), s = {
        ...
        boundingBox: Ut2(a.boundingBox ? a.boundingBox : {
          x1: 0,
          y1: 0,
          w: e.width(),
          h: e.height()
      ...
      for (s.graphSet.push(b); p <= m; ) {
        var M = y[p++], A2 = s.idToIndex[M], c = s.layoutNodes[A2], w = c.children;
        if (w.length > 0) {
          s.graphSet.push(w);
      ...
      for (var u = 0; u < s.edgeSize; u++) {
        var B = n[u], F2 = {};
        F2.id = B.data("id"), F2.sourceId = B.data("source"), F2.targetId = B.data("target");
        var R = Y(a.idealEdgeLength) ? a.idealEdgeLength(B) : a.idealEdgeLength, X = Y(a.edgeElasticity) ? a.edgeElasticity(B) : a.edgeElasticity, z = s.idToIndex[F2.sourceId], re = s.idToIndex[F2.targetId], W = s.indexToGraph[z], Z = s.indexToGraph[re];
        if (W != Z) {
          for (var ie = Xd(F2.sourceId, F2.targetId, s), oe = s.graphSet[ie], ge = 0, g = s.layoutNodes[z]; oe.indexOf(g.id) === -1; )
            g = s.layoutNodes[s.idToIndex[g.parentId]], ge++;
          for (g = s.layoutNodes[re]; oe.indexOf(g.id) === -1; )
            g = s.layoutNodes[s.idToIndex[g.parentId]], ge++;
          R *= ge * a.nestingFactor;
        }
        F2.idealLength = R, F2.elasticity = X, s.layoutEdges.push(F2);
      }
      return s;
    }, Xd = function(e, r, a) {
      var n = qd(e, r, 0, a);
    ...
    jo.prototype.run = function() {
      ...
      var i = Ut2(e.boundingBox ? e.boundingBox : {
        x1: 0,
        y1: 0,
        w: r.width(),
        h: r.height()
    ...
    tu.prototype.run = function() {
      var t = this.options, e = t.cy, r = t.eles, a = Ut2(t.boundingBox ? t.boundingBox : {
        x1: 0,
        y1: 0,
        w: e.width(),
        h: e.height()
    ...
    Vr.projectIntoViewport = function(t, e) {
      ...
      function p(w) {
        var I = w.outerWidth() + 2 * h, C = w.outerHeight() + 2 * h, B = I / 2, F2 = C / 2, R = w.position();
        if (R.x - B <= t && t <= R.x + B && R.y - F2 <= e && e <= R.y + F2) {
      ...
      function m(w) {
        var I = w._private, C = I.rscratch, B = w.pstyle("width").pfValue, F2 = w.pstyle("arrow-scale").value, R = B / 2 + f, X = R * R, z = R * 2, ie = I.source, oe = I.target, re;
        ...
        for (var ie = ie || I.source, oe = oe || I.target, ge = n.getArrowWidth(B, F2), se = [{
          name: "source",
          x: C.arrowStartX,
          y: C.arrowStartY,
      ...
      function E(w, I) {
        var C = w._private, B = c, F2;
        I ? F2 = I + "-" : F2 = "", w.boundingBox();
        var R = C.labelBounds[I || "main"], X = w.pstyle(F2 + "label").value, z = w.pstyle("text-events").strValue === "yes";
        if (!(!z || !X)) {
          var re = b(C.rscratch, "labelX", I), W = b(C.rscratch, "labelY", I), Z = b(C.rscratch, "labelAngle", I), ie = w.pstyle(F2 + "text-margin-x").pfValue, oe = w.pstyle(F2 + "text-margin-y").pfValue, ge = R.x1 - B - ie, se = R.x2 + B - ie, de = R.y1 - B - oe, we = R.y2 + B - oe;
          if (Z) {
      ...
      for (var M = s.length - 1; M >= 0; M--) {
        var A2 = s[M];
        A2.isNode() ? p(A2) || E(A2) : m(A2) || E(A2) || E(A2, "source") || E(A2, "target");
      }
      return o;
    ...
    Hn.calculateArrowAngles = function(t) {
      ...
      if (r && (p = (f + c) / 2, m = (h + v) / 2), l = c - f, u = v - h, i) {
        ...
        var d = e.allpts, A2 = e.ctrlpts, w, I, C, B;
        if (A2.length / 2 % 2 === 0) {
          var F2 = d.length / 2 - 1, R = F2 + 2, X = R + 2;
          w = St(d[F2], d[R], d[X], 0), I = St(d[F2 + 1], d[R + 1], d[X + 1], 0), C = St(d[F2], d[R], d[X], 1e-4), B = St(d[F2 + 1], d[R + 1], d[X + 1], 1e-4);
        } else {
          var R = d.length / 2 - 1, F2 = R - 2, X = R + 2;
          w = St(d[F2], d[R], d[X], 0.4999), I = St(d[F2 + 1], d[R + 1], d[X + 1], 0.4999), C = St(d[F2], d[R], d[X], 0.5), B = St(d[F2 + 1], d[R + 1], d[X + 1], 0.5);
        }
        l = C - w, u = B - I;
      }
    ...
    Vt.findHaystackPoints = function(t) {
      for (var e = 0; e < t.length; e++) {
        ...
        n.haystackPts = n.allpts = [n.source.x * f * g + l.x, n.source.y * c * g + l.y, n.target.x * h * g + u.x, n.target.y * v * g + u.y], n.midX = (n.allpts[0] + n.allpts[2]) / 2, n.midY = (n.allpts[1] + n.allpts[3]) / 2, n.edgeType = "haystack", n.haystack = true, this.storeEdgeProjections(r), this.calculateArrowAngles(r), this.recalculateEdgeLabelProjections(r), this.calculateLabelAngles(r);
      }
      ...
      var y = 50, p = {
        ...
        x: Math.min(p.x, m.x),
        y: Math.min(p.y, m.y)
      }, E = 0.5, M = Math.max(E, Math.log(o * 0.01)), A2 = Math.max(E, Math.log(u * 0.01));
      n.ctrlpts = [b.x, b.y - (1 + Math.pow(y, 1.12) / 100) * g * (d / 3 + 1) * M, b.x - (1 + Math.pow(y, 1.12) / 100) * g * (d / 3 + 1) * A2, b.y];
      ...
      for (var p = 0; p < v; p++) {
        ...
        var M = b !== void 0 ? b : m, A2 = 1 - g, w = g, I = u === "node-position" ? o : l, C = {
          x: I.x1 * A2 + I.x2 * w,
          y: I.y1 * A2 + I.y2 * w
        };
      ...
      if (ae && !ge)
        if (W) {
          ...
          var Ve = Math.abs(ie) <= h / 2, Fe = Math.abs(F2) <= d / 2;
          if (Ve) {
      ...
      if (r.edgeType === "bezier") {
        ...
        if (h || c || b) {
          ...
          }, R = u.intersectLine(a.x, a.y, i, s, F2.x, F2.y, 0);
      ...
      if (!(!t || t.length === 0)) {
        for (var r = this, a = r.cy, n = a.hasCompoundNodes(), i = {
          ...
          if (!(u.removed() || !u.takesUpSpace())) {
            ...
            b == null && (b = {
              eles: []
            }, i.set(m, b), s.push(m)), b.eles.push(u), c && (b.hasUnbundled = true), v && (b.hasBezier = true);
          }
        }
        for (var E = function(w) {
          var I = s[w], C = i.get(I), B = void 0;
          if (!C.hasUnbundled) {
            var F2 = C.eles[0].parallelEdges().filter(function(Se) {
              return Se.isBundledBezier();
            });
            oi(C.eles), F2.forEach(function(Se) {
    ...
    Qa.manualEndptToPx = function(t, e) {
      ...
      if (c.endX = Re[0], c.endY = Re[1], c.arrowEndX = qe[0], c.arrowEndY = qe[1], w === "inside-to-node")
        ...
        r = this.manualEndptToPx(a, A2);
      else if (w === "outside-to-line")
        r = c.srcIntn;
      else if (w === "outside-to-node" || w === "outside-to-node-or-label" ? X = F2 : (w === "outside-to-line" || w === "outside-to-line-or-label") && (X = [s.x, s.y]), r = e.nodeShapes[this.getNodeShape(a)].intersectLine(i.x, i.y, a.outerWidth(), a.outerHeight(), X[0], X[1], 0), w === "outside-to-node-or-label" || w === "outside-to-line-or-label") {
      ...
      var Le = yn(r, F2, e.arrowShapes[l].spacing(t) + f), ze = yn(r, F2, e.arrowShapes[l].gap(t) + f);
      ...
      if (i.mid || i.source || i.target) {
        ...
        var l = function f() {
          ...
          for (var b = 0; b < h.length; b++) {
            ...
            for (var A2 = 0; A2 < p - 1; A2++)
              m(E, y[b * p + A2], y[b * p + A2 + 1], n.bezierProjPcts[A2], n.bezierProjPcts[A2 + 1]);
              ...
              case "multibezier": {
                for (var g = l(), y, p = 0, m = 0, b = 0; b < g.length; b++) {
                  for (var E = g[v ? b : g.length - 1 - b], M = 0; M < E.segments.length; M++) {
                    var A2 = E.segments[v ? M : E.segments.length - 1 - M], w = b === g.length - 1 && M === E.segments.length - 1;
                    if (p = m, m += A2.length, m >= d || w) {
                      y = {
                        cp: E,
                        segment: A2
                      };
                ...
                var I = y.cp, C = y.segment, B = (d - p) / C.length, F2 = C.t1 - C.t0, R = v ? C.t0 + F2 * B : C.t1 - F2 * B;
...
`), h = t.pstyle("text-max-width").pfValue, c = t.pstyle("text-overflow-wrap").value, v = c === "anywhere", d = [], g = /[\s\u200b]+/, y = v ? "" : " ", p = 0; p < f.length; p++) {
          ...
          if (E > h) {
            for (var A2 = m.split(g), w = "", I = 0; I < A2.length; I++) {
              var C = A2[I], B = w.length === 0 ? C : w + y + C, F2 = this.calculateLabelDimensions(t, B), R = F2.width;
...
`), p = 0; p < y.length; p++) {
    ...
    ya.registerBinding = function(t, e, r, a) {
      ...
      M(t.container, function(Se) {
        t.registerBinding(Se, "transitionend", A2), t.registerBinding(Se, "animationend", A2), t.registerBinding(Se, "scroll", A2);
      ...
      var w = function() {
        ...
        if (!ze)
          return false;
        for (var Qe = t.container, ut = N.target, Ze = ut.parentNode, Je2 = false; Ze; ) {
          if (Ze === Qe) {
            Je2 = true;
            break;
          }
      ...
      t.registerBinding(t.container, "mousedown", function(N) {
            ...
            Le && Le.activate();
            {
              if (Le != null && t.nodeIsGrabbable(Le)) {
                ...
                if (u(Le), !Le.selected())
                  ...
                  var Ze = le.$(function(Je2) {
                    return Je2.isNode() && Je2.selected() && t.nodeIsGrabbable(Je2);
                  });
                  v(Ze, {
                    addToList: ze
        ...
        if (!(!le && !I(N))) {
          ...
          var ut = t.hoverData.last, Ze = t.hoverData.down, Je2 = [Le[0] - dt[2], Le[1] - dt[3]], Ct = t.dragData.possibleDragElements, It;
          if (at) {
          ...
          var Ir = function() {
            ...
            cr.length === 0 ? (cr.push(Je2[0]), cr.push(Je2[1])) : (cr[0] += Je2[0], cr[1] += Je2[1]);
          };
            ...
            if (Ze && Ze.pannable() && Ze.active() && Ze.unactivate(), (!Ze || !Ze.grabbed()) && Qe != ut && (ut && r(ut, ["mouseout", "tapdragout"], N, {
              ...
              if (It) {
                if (me.boxSelectionEnabled() && br)
                  ...
                  Ht && t.redrawHint("eles", true), t.dragData.didDrag = true, t.hoverData.draggingEles || v(Ct, {
                    inDragLayer: true
                  });
                  var Gt = {
                    x: 0,
                  ...
                  if (k(Je2[0]) && k(Je2[1]) && (Gt.x += Je2[0], Gt.y += Je2[1], Ht)) {
        ...
        if (le) {
          ...
          if (t.data.bgActivePosistion && (t.redrawHint("select", true), t.redraw()), t.hoverData.tapholdCancelled = true, t.data.bgActivePosistion = void 0, ze && ze.unactivate(), t.hoverData.which === 3) {
            ...
            !t.hoverData.isOverThresholdDrag && (r(ze, ["click", "tap", "vclick"], N, {
              x: me[0],
              y: me[1]
            }), B = false, N.timeStamp - F2 <= De.multiClickDebounceTime() ? (C && clearTimeout(C), B = true, F2 = null, r(ze, ["dblclick", "dbltap", "vdblclick"], N, {
              x: me[0],
              y: me[1]
            ...
            if (t.hoverData.dragging && (t.hoverData.dragging = false, t.redrawHint("select", true), t.redrawHint("eles", true), t.redraw()), !be[4]) {
              ...
              var Je2 = ze && ze.grabbed();
              g(Le), Je2 && (ze.emit("freeon"), Le.emit("free"), t.dragData.didDrag && (ze.emit("dragfreeon"), Le.emit("dragfree")));
            }
          }
      ...
      t.registerBinding(t.container, "touchstart", xe = function(N) {
        if (t.hasTouchStarted = true, !!I(N)) {
          ...
          if (N.touches[2])
            ...
            if (N.touches[0]) {
              var Ze = t.findNearestElements(De[0], De[1], true, true), Je2 = Ze[0];
              if (Je2 != null && (Je2.activate(), t.touchData.start = Je2, t.touchData.starts = Ze, t.nodeIsGrabbable(Je2))) {
                var Ct = t.dragData.touchDragEles = le.collection(), It = null;
                t.redrawHint("eles", true), t.redrawHint("drag", true), Je2.selected() ? (It = le.$(function(_t) {
                ...
                Je2.emit(ar("grabon")), It ? It.forEach(function(_t) {
                  _t.emit(ar("grab"));
                }) : Je2.emit(ar("grab"));
              }
              r(Je2, ["touchstart", "tapstart", "vmousedown"], N, {
                x: De[0],
                y: De[1]
              }), Je2 == null && (t.data.bgActivePosistion = {
                x: be[0],
                y: be[1]
        ...
        if (!(!le && !I(N))) {
          ...
          if (le && N.touches[0] && at) {
            for (var Qe = [], ut = 0; ut < be.length; ut++)
              Qe[ut] = be[ut] - Ke[ut];
            var Ze = N.touches[0].clientX - at[0], Je2 = Ze * Ze, Ct = N.touches[0].clientY - at[1], It = Ct * Ct, ar = Je2 + It;
      ...
      if (t.registerBinding(window, "touchend", Ie = function(N) {
        ...
        if (le != null && le.unactivate(), N.touches[2])
          ...
          if (!N.touches[0]) {
            if (!N.touches[0]) {
              t.data.bgActivePosistion = void 0, t.redrawHint("select", true);
              var Je2 = t.dragData.touchDragEles;
              if (le != null) {
                var Ct = le._private.grabbed;
                g(Je2), t.redrawHint("drag", true), t.redrawHint("eles", true), Ct && (le.emit("freeon"), Je2.emit("free"), t.dragData.didDrag && (le.emit("dragfreeon"), Je2.emit("dragfree"))), r(le, ["touchend", "tapend", "vmouseup", "tapdragout"], N, {
                  x: Le[0],
                  y: Le[1]
      ...
      return this.nodeShapes.barrel = {
        ...
        checkPoint: function(e, r, a, n, i, s, o) {
          ...
          for (var h = this.generateBarrelBezierPts(n, i, s, o), c = function(w, I, C) {
            var B = C[4], F2 = C[2], R = C[0], X = C[5], z = C[1], re = Math.min(B, R), W = Math.max(B, R), Z = Math.min(X, z), ie = Math.max(X, z);
            if (re <= w && w <= W && Z <= I && I <= ie) {
              var oe = Ff(B, F2, R), ge = Nf(oe[0], oe[1], oe[2], w), se = ge.filter(function(de) {
                return 0 <= de && de <= 1;
              });
              if (se.length > 0)
                return se[0];
    ...
    Dt.reasons = ba, Dt.getTextureQueue = function(t) {
      ...
      if (!this.isVisible(t, c))
        return null;
      var v = l.get(t, a);
      if (v && v.invalidated && (v.invalidated = false, v.texture.invalidatedWidth -= v.width), v)
        return v;
      var d;
      ...
      }, b = n && n === ba.dequeue, E = n && n === ba.highQuality, M = n && n === ba.downscale, A2, w = a + 1; w <= Vi; w++) {
        var I = l.get(t, w);
        if (I) {
          A2 = I;
          break;
      ...
      var C = A2 && A2.level === a + 1 ? A2 : null, B = function() {
      ...
      if (y.context.setTransform(1, 0, 0, 1, 0, 0), y.context.clearRect(y.usedWidth, 0, h, d), m(C))
        ...
        if (E) {
          for (var F2 = A2.level; F2 > a; F2--)
            C = i.getElement(t, e, r, F2, ba.downscale);
          B();
        } else
          return i.queueElement(t, A2.level - 1), A2;
      else {
        var R;
        if (!b && !E && !M)
    ...
    Mt.makeLayer = function(t, e) {
      ...
      for (var p = null, m = t.length / Mg, b = !o, E = 0; E < t.length; E++) {
        var M = t[E], A2 = M._private.rscratch, w = A2.imgLayerCaches = A2.imgLayerCaches || {}, I = w[r];
        if (I) {
          p = I;
          continue;
        }
    ...
    hr.drawElement = function(t, e, r, a, n, i) {
      ...
      if (!(u.w === 0 || u.h === 0)) {
        ...
        if (f != null) {
          ...
          if (c !== 0) {
            var A2 = r.getRotationPoint(e);
            b = A2.x, E = A2.y, t.translate(b, E), t.rotate(c), M = l.getImgSmoothing(t), M || l.setImgSmoothing(t, true);
    ...
    hr.drawCachedElement = function(t, e, r, a, n, i) {
      var s = this, o = s.data, l = o.eleTxrCache, u = o.lblTxrCache, f = o.slbTxrCache, h = o.tlbTxrCache, c = e.boundingBox(), v = i === true ? l.reasons.highQuality : null;
    ...
    mr.drawEdge = function(t, e, r) {
      ...
      if (!(i && !e.visible()) && !(o.badLine || o.allpts == null || isNaN(o.allpts[0]))) {
        ...
        t.lineJoin = "round";
        var A2 = e.pstyle("ghost").value === "yes";
        if (A2) {
    ...
    mr.drawEdgeOverlay = Tu("overlay"), mr.drawEdgeUnderlay = Tu("underlay"), mr.drawEdgePath = function(t, e, r, a) {
      ...
      var l = this, u = this.usePaths() && n !== "triangle-cross", f = false, h, c = e, v = {
        x: i,
        y: s
    ...
    Ui.safeDrawImage = function(t, e, r, a, n, i, s, o, l, u) {
      ...
      if (f(r, "background-width", "value", a) !== "auto" && (f(r, "background-width", "units", a) === "%" ? C = f(r, "background-width", "pfValue", a) * y : C = f(r, "background-width", "pfValue", a)), f(r, "background-height", "value", a) !== "auto" && (f(r, "background-height", "units", a) === "%" ? B = f(r, "background-height", "pfValue", a) * p : B = f(r, "background-height", "pfValue", a)), !(C === 0 || B === 0)) {
        if (h === "contain") {
          var F2 = Math.min(y / C, p / B);
          C *= F2, B *= F2;
        } else if (h === "cover") {
          var F2 = Math.max(y / C, p / B);
          C *= F2, B *= F2;
        }
        ...
        if (A2 === "no" && we ? (i.setImgSmoothing(t, false), Te = true) : A2 === "yes" && !we && (i.setImgSmoothing(t, true), Te = true), c === "no-repeat")
    ...
    _r.getTextAngle = function(t, e) {
      ...
      if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
        ...
        if (c != null && c !== "" && !isNaN(l) && !isNaN(u)) {
          ...
          var A2 = e.pstyle("text-background-opacity").value, w = e.pstyle("text-border-opacity").value, I = e.pstyle("text-border-width").pfValue, C = e.pstyle("text-background-padding").pfValue;
          if (A2 > 0 || I > 0 && w > 0) {
            var B = l - C;
            switch (b) {
              case "left":
            ...
            var F2 = u - g - C, R = d + 2 * C, X = g + 2 * C;
            if (A2 > 0) {
              var z = t.fillStyle, re = e.pstyle("text-background-color").value;
              t.fillStyle = "rgba(" + re[0] + "," + re[1] + "," + re[2] + "," + A2 * o + ")";
              var W = e.pstyle("text-background-shape").strValue;
              W.indexOf("round") === 0 ? Jg(t, B, F2, R, X, 2) : t.fillRect(B, F2, R, X), t.fillStyle = z;
            }
            if (I > 0 && w > 0) {
              ...
              if (t.strokeRect(B, F2, R, X), ge === "double") {
                var se = I / 2;
                t.strokeRect(B + se, F2 + se, R - se * 2, X - se * 2);
              }
    ...
    Ea.drawNode = function(t, e, r) {
      ...
      if (!(!k(h.x) || !k(h.y)) && !(i && !e.visible())) {
        var c = i ? e.effectiveOpacity() : 1, v = s.usePaths(), d, g = false, y = e.padding();
        o = e.width() + 2 * y, l = e.height() + 2 * y;
        var p;
        r && (p = r, t.translate(-p.x1, -p.y1));
        for (var m = e.pstyle("background-image"), b = m.value, E = new Array(b.length), M = new Array(b.length), A2 = 0, w = 0; w < b.length; w++) {
          var I = b[w], C = E[w] = I != null && I !== "none";
          if (C) {
            var B = e.cy().style().getIndexedStyle(e, "background-image-crossorigin", "value", w);
            A2++, M[w] = s.getCachedImage(I, B, function() {
              u.backgroundTimestamp = Date.now(), e.emitAndNotify("background");
            });
          }
        }
        var F2 = e.pstyle("background-blacken").value, R = e.pstyle("border-width").pfValue, X = e.pstyle("background-opacity").value * c, z = e.pstyle("border-color").value, re = e.pstyle("border-style").value, W = e.pstyle("border-opacity").value * c;
        t.lineJoin = "miter";
        var Z = function() {
        ...
        var Te = function() {
          ...
          u.backgrounding = We !== A2, et !== u.backgrounding && e.updateStyle(false);
        }, ye = function() {
          ...
          var ke = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, Ge = (F2 > 0 ? F2 : -F2) * ke, et = F2 > 0 ? 0 : 255;
          F2 !== 0 && (s.colorFillStyle(t, et, et, et, Ge), v ? t.fill(d) : t.fill());
        }, xe = function() {
          if (R > 0) {
        ...
        if (He) {
          ...
          t.translate(qe, Re), Z(Me * X), Te(), Ee(Ve, true), ie(Me * W), xe(), ye(F2 !== 0 || R !== 0), Ee(Ve, false), ae(Ve), t.translate(-qe, -Re);
        }
        v && t.translate(-h.x, -h.y), Oe(), v && t.translate(h.x, h.y), Z(), Te(), Ee(c, true), ie(), xe(), ye(F2 !== 0 || R !== 0), Ee(c, false), ae(), v && t.translate(-h.x, -h.y), Ie(), Ce(), r && t.translate(p.x1, p.y1);
      }
    };
    var Cu = function(e) {
      if (!["overlay", "underlay"].includes(e))
    ...
    Wt.getPixelRatio = function() {
      ...
      if (a === "radial-gradient")
        ...
        var b = s ? {
          x: 0,
          y: 0
        } : r.position(), E = r.paddedWidth(), M = r.paddedHeight(), A2 = E / 2, w = M / 2, I = r.pstyle("background-gradient-direction").value;
        switch (I) {
          case "to-bottom":
          ...
          case "to-top":
            ...
            break;
          case "to-left":
            i = t.createLinearGradient(b.x + A2, b.y, b.x - A2, b.y);
            break;
          case "to-right":
            i = t.createLinearGradient(b.x - A2, b.y, b.x + A2, b.y);
            break;
          ...
          case "to-right-bottom":
            i = t.createLinearGradient(b.x - A2, b.y - w, b.x + A2, b.y + w);
            break;
          case "to-top-right":
          case "to-right-top":
            i = t.createLinearGradient(b.x - A2, b.y + w, b.x + A2, b.y - w);
      ...
      if (!i)
        return null;
      for (var C = l.length === o.length, B = o.length, F2 = 0; F2 < B; F2++)
        i.addColorStop(C ? l[F2] : F2 / (B - 1), "rgba(" + o[F2][0] + "," + o[F2][1] + "," + o[F2][2] + "," + n + ")");
      return i;
      ...
      var m = l.style(), b = l.zoom(), E = n !== void 0 ? n : b, M = l.pan(), A2 = {
        x: M.x,
        y: M.y
      }, w = {
        zoom: b,
      ...
      !C && !(g && !d) && (s.motionBlurPxRatio = 1), i && (A2 = i), E *= o, A2.x *= o, A2.y *= o;
      var B = s.getCachedZSortedEles();
      function F2(Re, Me, Ve, Fe, ke) {
      ...
      function R(Re, Me) {
        ...
        !s.clearingMotionBlur && (Re === u.bufferContexts[s.MOTIONBLUR_BUFFER_NODE] || Re === u.bufferContexts[s.MOTIONBLUR_BUFFER_DRAG]) ? (Ve = {
          x: M.x * v,
          y: M.y * v
        }, Fe = b * v, ke = s.canvasWidth * v, Ge = s.canvasHeight * v) : (Ve = A2, Fe = E, ke = s.canvasWidth, Ge = s.canvasHeight), Re.setTransform(1, 0, 0, 1, 0, 0), Me === "motionBlur" ? F2(Re, 0, 0, ke, Ge) : !e && (Me === void 0 || Me) && Re.clearRect(0, 0, ke, Ge), r || (Re.translate(Ve.x, Ve.y), Re.scale(Fe, Fe)), i && Re.translate(i.x, i.y), n && Re.scale(n, n);
      }
      if (h || (s.textureDrawLastFrame = false), h) {
        ...
        z.setTransform(1, 0, 0, 1, 0, 0), c ? F2(z, 0, 0, w.width, w.height) : z.clearRect(0, 0, w.width, w.height);
        ...
        var b = l.zoom();
        R(z, false), z.clearRect(w.mpan.x, w.mpan.y, w.width / w.zoom / o, w.height / w.zoom / o), z.drawImage(re, w.mpan.x, w.mpan.y, w.width / w.zoom / o, w.height / w.zoom / o);
      } else
      ...
      if (c && v !== 1) {
        var Ce = u.contexts[s.NODE], Oe = s.data.bufferCanvases[s.MOTIONBLUR_BUFFER_NODE], Ie = u.contexts[s.DRAG], He = s.data.bufferCanvases[s.MOTIONBLUR_BUFFER_DRAG], qe = function(Me, Ve, Fe) {
          Me.setTransform(1, 0, 0, 1, 0, 0), Fe || !p ? Me.clearRect(0, 0, s.canvasWidth, s.canvasHeight) : F2(Me, 0, 0, s.canvasWidth, s.canvasHeight);
          var ke = v;
          Me.drawImage(
            Ve,
            // img
      ...
      s.prevViewport = w, s.clearingMotionBlur && (s.clearingMotionBlur = false, s.motionBlurCleared = true, s.motionBlur = true), c && (s.motionBlurTimeout = setTimeout(function() {
    ...
    function Mu(t) {
      ...
      var u = Ut2(), f = function(ae) {
        ...
        return F2("", R(ae, "labelX", "labelY"), ae);
      }, z = function(ae) {
        return F2("source", R(ae, "sourceLabelX", "sourceLabelY"), ae);
      }, re = function(ae) {
        return F2("target", R(ae, "targetLabelX", "targetLabelY"), ae);
      }, W = function(ae) {
        return h(M(ae));
      }, Z = function(ae) {
        return h(w(ae));
      ...
      return (
        ...
        function(ee) {
          ...
          function(ee, ve, H) {
            ...
            S2.prototype = Object.create(O.prototype);
            for (var G in O)
              S2[G] = O[G];
            ...
            }, S2.prototype.getLength = function() {
              return this.length;
            ...
            }, S2.prototype.getOtherEnd = function(U) {
              if (this.source === U)
                return this.target;
              if (this.target === U)
                return this.source;
              throw "Node is not incident with this edge";
            }, S2.prototype.getOtherEndInGraph = function(U, P) {
          ...
          /***/
          function(ee, ve, H) {
            var O = H(2), T = H(10), x = H(13), S2 = H(0), G = H(16), U = H(4);
            function P(D, V, _, Q) {
            ...
            P.prototype.getEdges = function() {
              ...
              var D, V, _ = -S2.INITIAL_WORLD_BOUNDARY, Q = S2.INITIAL_WORLD_BOUNDARY;
              D = S2.WORLD_CENTER_X + G.nextDouble() * (Q - _) + _;
              var ne = -S2.INITIAL_WORLD_BOUNDARY, ue = S2.INITIAL_WORLD_BOUNDARY;
              V = S2.WORLD_CENTER_Y + G.nextDouble() * (ue - ne) + ne, this.rect.x = D, this.rect.y = V;
            }, P.prototype.updateBounds = function() {
              if (this.getChild() == null)
                throw "assert failed";
              if (this.getChild().getNodes().length != 0) {
                var D = this.getChild();
                if (D.updateBounds(true), this.rect.x = D.getLeft(), this.rect.y = D.getTop(), this.setWidth(D.getRight() - D.getLeft()), this.setHeight(D.getBottom() - D.getTop()), S2.NODE_DIMENSIONS_INCLUDE_LABELS) {
              ...
              var V = this.rect.x;
              V > S2.WORLD_BOUNDARY ? V = S2.WORLD_BOUNDARY : V < -S2.WORLD_BOUNDARY && (V = -S2.WORLD_BOUNDARY);
              var _ = this.rect.y;
              _ > S2.WORLD_BOUNDARY ? _ = S2.WORLD_BOUNDARY : _ < -S2.WORLD_BOUNDARY && (_ = -S2.WORLD_BOUNDARY);
          ...
          /***/
          function(ee, ve, H) {
            var O = H(2), T = H(10), x = H(0), S2 = H(6), G = H(3), U = H(1), P = H(13), K = H(12), D = H(11);
            function V(Q, ne, ue) {
              O.call(this, ue), this.estimatedSize = T.MIN_VALUE, this.margin = x.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = Q, ne != null && ne instanceof S2 ? this.graphManager = ne : ne != null && ne instanceof Layout && (this.graphManager = ne.graphManager);
            }
          ...
          function(ee, ve, H) {
            var O, T = H(1);
            function x(S2) {
              O = H(5), this.layout = S2, this.graphs = [], this.edges = [];
            }
            x.prototype.addRoot = function() {
              var S2 = this.layout.newGraph(), G = this.layout.newNode(null), U = this.add(S2, G);
              return this.setRootGraph(U), this.rootGraph;
            }, x.prototype.add = function(S2, G, U, P, K) {
              if (U == null && P == null && K == null) {
                if (S2 == null)
                  throw "Graph is null!";
                if (G == null)
                  throw "Parent node is null!";
                if (this.graphs.indexOf(S2) > -1)
                  throw "Graph already in this graph mgr!";
                if (this.graphs.push(S2), S2.parent != null)
                  throw "Already has a parent!";
                if (G.child != null)
                  throw "Already has a child!";
                return S2.parent = G, G.child = S2, S2;
              } else {
                K = U, P = G, U = S2;
            ...
            }, x.prototype.remove = function(S2) {
              if (S2 instanceof O) {
                var G = S2;
              ...
              if (this.allNodes == null) {
                for (var S2 = [], G = this.getGraphs(), U = G.length, P = 0; P < U; P++)
                  S2 = S2.concat(G[P].getNodes());
                this.allNodes = S2;
              }
              ...
              if (this.allEdges == null) {
                var S2 = [], G = this.getGraphs();
                G.length;
                for (var U = 0; U < G.length; U++)
                  S2 = S2.concat(G[U].getEdges());
                S2 = S2.concat(this.edges), this.allEdges = S2;
              }
              return this.allEdges;
            }, x.prototype.getAllNodesToApplyGravitation = function() {
              return this.allNodesToApplyGravitation;
            }, x.prototype.setAllNodesToApplyGravitation = function(S2) {
              if (this.allNodesToApplyGravitation != null)
                throw "assert failed";
              this.allNodesToApplyGravitation = S2;
            }, x.prototype.getRoot = function() {
              return this.rootGraph;
            }, x.prototype.setRootGraph = function(S2) {
              if (S2.getGraphManager() != this)
                throw "Root not in this graph mgr!";
              this.rootGraph = S2, S2.parent == null && (S2.parent = this.layout.newNode("Root node"));
            }, x.prototype.getLayout = function() {
              return this.layout;
            }, x.prototype.isOneAncestorOfOther = function(S2, G) {
              if (!(S2 != null && G != null))
                throw "assert failed";
              if (S2 == G)
                return true;
              ...
              for (var S2, G, U, P, K, D = this.getAllEdges(), V = D.length, _ = 0; _ < V; _++) {
                if (S2 = D[_], G = S2.source, U = S2.target, S2.lca = null, S2.sourceInLca = G, S2.targetInLca = U, G == U) {
                  S2.lca = G.getOwner();
                  continue;
                }
                for (P = G.getOwner(); S2.lca == null; ) {
                  for (S2.targetInLca = U, K = U.getOwner(); S2.lca == null; ) {
                    if (K == P) {
                      S2.lca = K;
                      break;
                    }
                    ...
                    if (S2.lca != null)
                      throw "assert failed";
                    S2.targetInLca = K.getParent(), K = S2.targetInLca.getOwner();
                  }
                  if (P == this.rootGraph)
                    break;
                  S2.lca == null && (S2.sourceInLca = P.getParent(), P = S2.sourceInLca.getOwner());
                }
                if (S2.lca == null)
                  throw "assert failed";
              }
            }, x.prototype.calcLowestCommonAncestor = function(S2, G) {
              if (S2 == G)
                return S2.getOwner();
              var U = S2.getOwner();
              do {
              ...
              return U;
            }, x.prototype.calcInclusionTreeDepths = function(S2, G) {
              S2 == null && G == null && (S2 = this.rootGraph, G = 1);
              for (var U, P = S2.getNodes(), K = P.length, D = 0; D < K; D++)
              ...
              for (var S2, G = this.edges.length, U = 0; U < G; U++)
                if (S2 = this.edges[U], this.isOneAncestorOfOther(S2.source, S2.target))
                  return true;
              return false;
            }, ee.exports = x;
          },
          ...
          function(ee, ve, H) {
            ...
            T.calcSeparationAmount = function(x, S2, G, U) {
              if (!x.intersects(S2))
                throw "assert failed";
              var P = new Array(2);
              this.decideDirectionsForOverlappingNodes(x, S2, P), G[0] = Math.min(x.getRight(), S2.getRight()) - Math.max(x.x, S2.x), G[1] = Math.min(x.getBottom(), S2.getBottom()) - Math.max(x.y, S2.y), x.getX() <= S2.getX() && x.getRight() >= S2.getRight() ? G[0] += Math.min(S2.getX() - x.getX(), x.getRight() - S2.getRight()) : S2.getX() <= x.getX() && S2.getRight() >= x.getRight() && (G[0] += Math.min(x.getX() - S2.getX(), S2.getRight() - x.getRight())), x.getY() <= S2.getY() && x.getBottom() >= S2.getBottom() ? G[1] += Math.min(S2.getY() - x.getY(), x.getBottom() - S2.getBottom()) : S2.getY() <= x.getY() && S2.getBottom() >= x.getBottom() && (G[1] += Math.min(x.getY() - S2.getY(), S2.getBottom() - x.getBottom()));
              var K = Math.abs((S2.getCenterY() - x.getCenterY()) / (S2.getCenterX() - x.getCenterX()));
              S2.getCenterY() === x.getCenterY() && S2.getCenterX() === x.getCenterX() && (K = 1);
              var D = K * G[0], V = G[1] / K;
              G[0] < V ? V = G[0] : D = G[1], G[0] = -1 * P[0] * (V / 2 + U), G[1] = -1 * P[1] * (D / 2 + U);
            }, T.decideDirectionsForOverlappingNodes = function(x, S2, G) {
              x.getCenterX() < S2.getCenterX() ? G[0] = -1 : G[0] = 1, x.getCenterY() < S2.getCenterY() ? G[1] = -1 : G[1] = 1;
            }, T.getIntersection2 = function(x, S2, G) {
              var U = x.getCenterX(), P = x.getCenterY(), K = S2.getCenterX(), D = S2.getCenterY();
              if (x.intersects(S2))
                return G[0] = U, G[1] = P, G[2] = K, G[3] = D, true;
              var V = x.getX(), _ = x.getY(), Q = x.getRight(), ne = x.getX(), ue = x.getBottom(), J = x.getRight(), j = x.getWidthHalf(), Y = x.getHeightHalf(), te = S2.getX(), L = S2.getY(), $ = S2.getRight(), k = S2.getX(), q = S2.getBottom(), ce = S2.getRight(), pe = S2.getWidthHalf(), Ae = S2.getHeightHalf(), Ne = false, _e = false;
              if (U === K) {
                if (P > D)
                ...
                var tt = x.height / x.width, ct = S2.height / S2.width, Pe = (D - P) / (K - U), $e = void 0, Xe = void 0, rt = void 0, lt = void 0, nt = void 0, je = void 0;
              ...
              return false;
            }, T.getCardinalDirection = function(x, S2, G) {
              return x > S2 ? G : 1 + G % 4;
            }, T.getIntersection = function(x, S2, G, U) {
              if (U == null)
                return this.getIntersection2(x, S2, G);
              var P = x.x, K = x.y, D = S2.x, V = S2.y, _ = G.x, Q = G.y, ne = U.x, ue = U.y, J = void 0, j = void 0, Y = void 0, te = void 0, L = void 0, $ = void 0, k = void 0, q = void 0, ce = void 0;
              return Y = V - K, L = P - D, k = D * K - P * V, te = ue - Q, $ = _ - ne, q = ne * Q - _ * ue, ce = Y * $ - te * L, ce === 0 ? null : (J = (L * q - $ * k) / ce, j = (te * k - Y * q) / ce, new O(J, j));
            }, T.angleOfVector = function(x, S2, G, U) {
              var P = void 0;
              return x !== G ? (P = Math.atan((U - S2) / (G - x)), G < x ? P += Math.PI : U < S2 && (P += this.TWO_PI)) : U < S2 ? P = this.ONE_AND_HALF_PI : P = this.HALF_PI, P;
            }, T.doIntersect = function(x, S2, G, U) {
              var P = x.x, K = x.y, D = S2.x, V = S2.y, _ = G.x, Q = G.y, ne = U.x, ue = U.y, J = (D - P) * (ue - Q) - (ne - _) * (V - K);
              if (J === 0)
                return false;
          ...
          function(ee, ve, H) {
            ...
            var x = function(K) {
              ...
              return O(P, [{
                ...
                key: "insertBefore",
                value: function(D, V) {
                  return S2(V.prev, x(D), V, this);
                }
              }, {
                key: "insertAfter",
                value: function(D, V) {
                  return S2(V, x(D), V.next, this);
                }
              }, {
                key: "insertNodeBefore",
                value: function(D, V) {
                  return S2(V.prev, D, V, this);
                }
              }, {
                key: "insertNodeAfter",
                value: function(D, V) {
                  return S2(V, D, V.next, this);
                }
              }, {
                key: "push",
                value: function(D) {
                  return S2(this.tail, x(D), null, this);
                }
              }, {
                key: "unshift",
                value: function(D) {
                  return S2(null, x(D), this.head, this);
                }
              }, {
                key: "remove",
                value: function(D) {
          ...
          function(ee, ve, H) {
            function O(T, x, S2) {
              this.x = null, this.y = null, T == null && x == null && S2 == null ? (this.x = 0, this.y = 0) : typeof T == "number" && typeof x == "number" && S2 == null ? (this.x = T, this.y = x) : T.constructor.name == "Point" && x == null && S2 == null && (S2 = T, this.x = S2.x, this.y = S2.y);
            }
            O.prototype.getX = function() {
              return this.x;
            }, O.prototype.getY = function() {
              ...
              return new O(this.x, this.y);
            }, O.prototype.setLocation = function(T, x, S2) {
              T.constructor.name == "Point" && x == null && S2 == null ? (S2 = T, this.setLocation(S2.x, S2.y)) : typeof T == "number" && typeof x == "number" && S2 == null && (parseInt(T) == T && parseInt(x) == x ? this.move(T, x) : (this.x = Math.floor(T + 0.5), this.y = Math.floor(x + 0.5)));
          ...
          function(ee, ve, H) {
            function O(T, x, S2, G) {
              this.x = 0, this.y = 0, this.width = 0, this.height = 0, T != null && x != null && S2 != null && G != null && (this.x = T, this.y = x, this.width = S2, this.height = G);
            }
            O.prototype.getX = function() {
              return this.x;
            }, O.prototype.setX = function(T) {
          ...
          function(ee, ve, H) {
            ...
            T.lastID = 0, T.createID = function(x) {
              ...
              var S2 = typeof x > "u" ? "undefined" : O(x);
              return x == null || S2 != "object" && S2 != "function";
            }, ee.exports = T;
          },
          /* 15 */
          /***/
          function(ee, ve, H) {
            ...
            var T = H(0), x = H(6), S2 = H(3), G = H(1), U = H(5), P = H(4), K = H(17), D = H(27);
            function V(_) {
            ...
            V.RANDOM_SEED = 1, V.prototype = Object.create(D.prototype), V.prototype.getGraphManager = function() {
              ...
              return new S2(this.graphManager, _);
          ...
          function(ee, ve, H) {
            ...
            T.prototype.getWorldOrgX = function() {
              ...
              var S2 = 0, G = this.lworldExtX;
              return G != 0 && (S2 = this.ldeviceOrgX + (x - this.lworldOrgX) * this.ldeviceExtX / G), S2;
            }, T.prototype.transformY = function(x) {
              var S2 = 0, G = this.lworldExtY;
              return G != 0 && (S2 = this.ldeviceOrgY + (x - this.lworldOrgY) * this.ldeviceExtY / G), S2;
            }, T.prototype.inverseTransformX = function(x) {
              var S2 = 0, G = this.ldeviceExtX;
              return G != 0 && (S2 = this.lworldOrgX + (x - this.ldeviceOrgX) * this.lworldExtX / G), S2;
            }, T.prototype.inverseTransformY = function(x) {
              var S2 = 0, G = this.ldeviceExtY;
              return G != 0 && (S2 = this.lworldOrgY + (x - this.ldeviceOrgY) * this.lworldExtY / G), S2;
            }, T.prototype.inverseTransformPoint = function(x) {
              var S2 = new O(this.inverseTransformX(x.x), this.inverseTransformY(x.y));
              return S2;
            }, ee.exports = T;
          },
          /* 18 */
          ...
          function(ee, ve, H) {
            ...
            var T = H(15), x = H(7), S2 = H(0), G = H(8), U = H(9);
            function P() {
            ...
            P.prototype.initParameters = function() {
              ...
              for (var D, V, _, Q, ne, ue, J = this.getGraphManager().getAllEdges(), j = 0; j < J.length; j++)
                D = J[j], D.idealLength = this.idealEdgeLength, D.isInterGraph && (_ = D.getSource(), Q = D.getTarget(), ne = D.getSourceInLca().getEstimatedSize(), ue = D.getTargetInLca().getEstimatedSize(), this.useSmartIdealEdgeLengthCalculation && (D.idealLength += ne + ue - 2 * S2.SIMPLE_NODE_SIZE), V = D.getLca().getInclusionTreeDepth(), D.idealLength += x.DEFAULT_EDGE_LENGTH * x.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR * (_.getInclusionTreeDepth() + Q.getInclusionTreeDepth() - 2 * V));
          ...
          function(ee, ve, H) {
            var O = H(3);
            function T(S2, G, U, P) {
              O.call(this, S2, G, U, P), this.springForceX = 0, this.springForceY = 0, this.repulsionForceX = 0, this.repulsionForceY = 0, this.gravitationForceX = 0, this.gravitationForceY = 0, this.displacementX = 0, this.displacementY = 0, this.startX = 0, this.finishX = 0, this.startY = 0, this.finishY = 0, this.surrounding = [];
            }
            T.prototype = Object.create(O.prototype);
            for (var x in O)
              T[x] = O[x];
            T.prototype.setGridCoordinates = function(S2, G, U, P) {
              this.startX = S2, this.finishX = G, this.startY = U, this.finishY = P;
            }, ee.exports = T;
          },
          /* 21 */
          /***/
          ...
          function(ee, ve, H) {
            ...
            T.prototype.put = function(x, S2) {
              var G = O.createID(x);
              this.contains(G) || (this.map[G] = S2, this.keys.push(x));
          ...
          function(ee, ve, H) {
            ...
            T.prototype.add = function(x) {
              var S2 = O.createID(x);
              this.contains(S2) || (this.set[S2] = x);
              ...
              for (var S2 = Object.keys(this.set), G = S2.length, U = 0; U < G; U++)
                x.push(this.set[S2[U]]);
            }, T.prototype.size = function() {
              return Object.keys(this.set).length;
            }, T.prototype.addAll = function(x) {
              for (var S2 = x.length, G = 0; G < S2; G++) {
                var U = x[G];
                this.add(U);
              }
            }, ee.exports = T;
          ...
          function(ee, ve, H) {
            var O = function() {
              ...
              return function(G, U, P) {
                return U && S2(G.prototype, U), P && S2(G, P), G;
              };
            }();
            function T(S2, G) {
              if (!(S2 instanceof G))
            ...
            var x = function() {
              function S2(G, U) {
                ...
                T(this, S2), this.sequence1 = G, this.sequence2 = U, this.match_score = P, this.mismatch_penalty = K, this.gap_penalty = D, this.iMax = G.length + 1, this.jMax = U.length + 1, this.grid = new Array(this.iMax);
          ...
          function(ee, ve, H) {
            ...
            var T = O.prototype;
            T.addListener = function(x, S2) {
              this.listeners.push({
                event: x,
                callback: S2
              });
            }, T.removeListener = function(x, S2) {
              for (var G = this.listeners.length; G >= 0; G--) {
                var U = this.listeners[G];
                U.event === x && U.callback === S2 && this.listeners.splice(G, 1);
              }
            }, T.emit = function(x, S2) {
              for (var G = 0; G < this.listeners.length; G++) {
                var U = this.listeners[G];
                x === U.event && U.callback(S2);
              }
            }, ee.exports = O;
          }
          /******/
      ...
      return (
        ...
        function(ve) {
          ...
          function(ve, H, O) {
            ...
            S2.prototype = Object.create(T.prototype);
            for (var G in T)
              S2[G] = T[G];
            S2.prototype.move = function() {
            ...
            }, S2.prototype.propogateDisplacementToChildren = function(U, P) {
            ...
            }, S2.prototype.setPred1 = function(U) {
              this.pred1 = U;
            }, S2.prototype.getPred1 = function() {
              return pred1;
            }, S2.prototype.getPred2 = function() {
              return pred2;
            }, S2.prototype.setNext = function(U) {
              this.next = U;
            }, S2.prototype.getNext = function() {
              return next;
            }, S2.prototype.setProcessed = function(U) {
              this.processed = U;
            }, S2.prototype.isProcessed = function() {
              return processed;
            }, ve.exports = S2;
          },
          /* 6 */
          /***/
          function(ve, H, O) {
            var T = O(0).FDLayout, x = O(4), S2 = O(3), G = O(5), U = O(2), P = O(1), K = O(0).FDLayoutConstants, D = O(0).LayoutConstants, V = O(0).Point, _ = O(0).PointD, Q = O(0).Layout, ne = O(0).Integer, ue = O(0).IGeometry, J = O(0).LGraph, j = O(0).Transform;
            function Y() {
            ...
            Y.prototype.newGraphManager = function() {
              ...
              return new S2(null, this.graphManager, L);
  ...
  (function(ve, H) {
    ...
    return (
      ...
      function(ve) {
        ...
        /***/
        function(ve, H, O) {
          var T = O(0).layoutBase.LayoutConstants, x = O(0).layoutBase.FDLayoutConstants, S2 = O(0).CoSEConstants, G = O(0).CoSELayout, U = O(0).CoSENode, P = O(0).layoutBase.PointD, K = O(0).layoutBase.DimensionD, D = {
            // Called on `layoutready`
            ready: function() {
            },
            // Called on `layoutstop`
          ...
          var Q = function(J) {
            J.nodeRepulsion != null && (S2.DEFAULT_REPULSION_STRENGTH = x.DEFAULT_REPULSION_STRENGTH = J.nodeRepulsion), J.idealEdgeLength != null && (S2.DEFAULT_EDGE_LENGTH = x.DEFAULT_EDGE_LENGTH = J.idealEdgeLength), J.edgeElasticity != null && (S2.DEFAULT_SPRING_STRENGTH = x.DEFAULT_SPRING_STRENGTH = J.edgeElasticity), J.nestingFactor != null && (S2.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = x.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = J.nestingFactor), J.gravity != null && (S2.DEFAULT_GRAVITY_STRENGTH = x.DEFAULT_GRAVITY_STRENGTH = J.gravity), J.numIter != null && (S2.MAX_ITERATIONS = x.MAX_ITERATIONS = J.numIter), J.gravityRange != null && (S2.DEFAULT_GRAVITY_RANGE_FACTOR = x.DEFAULT_GRAVITY_RANGE_FACTOR = J.gravityRange), J.gravityCompound != null && (S2.DEFAULT_COMPOUND_GRAVITY_STRENGTH = x.DEFAULT_COMPOUND_GRAVITY_STRENGTH = J.gravityCompound), J.gravityRangeCompound != null && (S2.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = x.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = J.gravityRangeCompound), J.initialEnergyOnIncremental != null && (S2.DEFAULT_COOLING_FACTOR_INCREMENTAL = x.DEFAULT_COOLING_FACTOR_INCREMENTAL = J.initialEnergyOnIncremental), J.quality == "draft" ? T.QUALITY = 0 : J.quality == "proof" ? T.QUALITY = 2 : T.QUALITY = 1, S2.NODE_DIMENSIONS_INCLUDE_LABELS = x.NODE_DIMENSIONS_INCLUDE_LABELS = T.NODE_DIMENSIONS_INCLUDE_LABELS = J.nodeDimensionsIncludeLabels, S2.DEFAULT_INCREMENTAL = x.DEFAULT_INCREMENTAL = T.DEFAULT_INCREMENTAL = !J.randomize, S2.ANIMATE = x.ANIMATE = T.ANIMATE = J.animate, S2.TILE = J.tile, S2.TILING_PADDING_VERTICAL = typeof J.tilingPaddingVertical == "function" ? J.tilingPaddingVertical.call() : J.tilingPaddingVertical, S2.TILING_PADDING_HORIZONTAL = typeof J.tilingPaddingHorizontal == "function" ? J.tilingPaddingHorizontal.call() : J.tilingPaddingHorizontal;
          };
...
function jp(he, fe) {
  fe.edges().map((ee, ve) => {
    ...
    if (ee[0]._private.bodyBounds) {
      ...
      S.trace("Edge: ", ve, H), he.insert("path").attr(
        "d",
...
function ey(he, fe) {
  return new Promise((ee) => {
    const ve = At("body").append("div").attr("id", "cy").attr("style", "display:none"), H = Wu({
...
function ty(he) {
  he.nodes().map((fe, ee) => {
    ...
    S.info("Id:", ee, "Position: (", fe.position().x, ", ", fe.position().y, ")", ve), H.attr(
      "transform",
...
var ry = async (he, fe, ee, ve) => {
  const H = Ut();
  H.htmlLabels = false, ve.db.clear(), ve.parser.parse(he), S.debug(`Rendering mindmap diagram
` + he, ve.parser);
  const O = Ut().securityLevel;
  let T;
  O === "sandbox" && (T = At("#i" + fe));
  const S2 = (O === "sandbox" ? At(T.nodes()[0].contentDocument.body) : At("body")).select("#" + fe);
  S2.append("g");
  const G = ve.db.getMindmap(), U = S2.append("g");
  U.attr("class", "mindmap-edges");
  const P = S2.append("g");
  P.attr("class", "mindmap-nodes"), Ku(P, G, -1, H);
  const K = await ey(G, H);
  jp(U, K), ty(K), jg(void 0, S2, H.mindmap.padding, H.mindmap.useMaxWidth);
};
var ay = {
  draw: ry
};
var ny = (he) => {
  ...
  for (let ee = 0; ee < he.THEME_COLOR_LIMIT; ee++)
    he["lineColor" + ee] = he["lineColor" + ee] || he["cScaleInv" + ee], si(he["lineColor" + ee]) ? he["lineColor" + ee] = F(he["lineColor" + ee], 20) : he["lineColor" + ee] = A(he["lineColor" + ee], 20);
  for (let ee = 0; ee < he.THEME_COLOR_LIMIT; ee++) {
    const ve = "" + (17 - 3 * ee);
    fe += `
...
mermaid/dist/mindmap-definition-825812a2.js:
  (*!
...
*/
//# sourceMappingURL=mindmap-definition-825812a2-GFV6NXDZ.js.map
