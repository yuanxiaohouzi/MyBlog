...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/index-bf86b901.js
var K = 4;
function Q(e) {
  return dn(e, K);
}
...
var st = (e, t) => {
  ...
  const n = e.insert("g").attr("class", "cluster" + (t.class ? " " + t.class : "")).attr("id", t.id), r = n.insert("rect", ":first-child"), s = ia(Ut().flowchart.htmlLabels), a = n.insert("g").attr("class", "cluster-label"), u = t.labelType === "markdown" ? Or(a, t.labelText, { style: t.labelStyle, useHtmlLabels: s }) : a.node().appendChild(T(t.labelText, t.labelStyle, void 0, true));
  let l = u.getBBox();
...
//# sourceMappingURL=chunk-L2SUHFD6.js.map
