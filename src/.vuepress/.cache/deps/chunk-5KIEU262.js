// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/mermaid-08b2ff5f.js
function ql(t9) {
...
var Go = 0;
var T0 = () => (Go++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Go);
function S0(t9) {
  let e = "";
...
function Y0(t9) {
  return z0($i("", null, null, null, [""], t9 = P0(t9), 0, [0], t9));
}
...
function Vo(t9, e, i, r, n, o, s, a, l, h, c) {
  for (var u = n - 1, g = n === 0 ? o : [""], p = Ka(g), _ = 0, v = 0, M = 0; _ < r; ++_)
    for (var q = 0, k = ri(t9, u + 1, u = D0(v = s[_])), z = t9; q < p; ++q)
      (z = Xa(v > 0 ? g[q] + " " + k : on(k, /&\f/g, g[q]))) && (l[M++] = z);
  return qn(t9, e, i, n === 0 ? Ga : a, l, h, c);
}
function G0(t9, e, i) {
  return qn(t9, e, i, Ya, Rn(R0()), ri(t9, 2, -2), 0);
}
...
var Ko = "10.2.2";
var Ja = "c4";
var X0 = (t9) => t9.match(/^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/) !== null;
var K0 = async () => {
  const { diagram: t9 } = await import("./c4Diagram-30400ad0-ZL5TD5F6.js");
...
var t_ = async () => {
  const { diagram: t9 } = await import("./flowDiagram-d3a638d5-PKV7WYRC.js");
...
var n_ = async () => {
  const { diagram: t9 } = await import("./flowDiagram-v2-c75a17c2-BHQW2WW4.js");
...
var s_ = o_;
var el = "er";
var a_ = (t9) => t9.match(/^\s*erDiagram/) !== null;
var l_ = async () => {
  const { diagram: t9 } = await import("./erDiagram-79324bed-YDJZYY2E.js");
...
var c_ = h_;
var il = "gitGraph";
var u_ = (t9) => t9.match(/^\s*gitGraph/) !== null;
var f_ = async () => {
  const { diagram: t9 } = await import("./gitGraphDiagram-bd04333d-D6ITPYZO.js");
...
var p_ = d_;
var rl = "gantt";
var g_ = (t9) => t9.match(/^\s*gantt/) !== null;
var m_ = async () => {
  const { diagram: t9 } = await import("./ganttDiagram-eddf2b5d-TI2SCOI2.js");
...
var y_ = __;
var nl = "info";
var C_ = (t9) => t9.match(/^\s*info/) !== null;
var x_ = async () => {
  const { diagram: t9 } = await import("./infoDiagram-d8edadcf-HQVDMSJR.js");
...
var T_ = b_;
var ol = "pie";
var S_ = (t9) => t9.match(/^\s*pie/) !== null;
var k_ = async () => {
  const { diagram: t9 } = await import("./pieDiagram-9f52f3c8-XM2TGCUQ.js");
...
var B_ = (t9) => t9.match(/^\s*quadrantChart/) !== null;
var F_ = async () => {
  const { diagram: t9 } = await import("./quadrantDiagram-0bfe3602-LENVC6H6.js");
...
var A_ = L_;
var al = "requirement";
var E_ = (t9) => t9.match(/^\s*requirement(Diagram)?/) !== null;
var M_ = async () => {
  const { diagram: t9 } = await import("./requirementDiagram-480c4b33-FUBZ25JD.js");
...
var I_ = O_;
var ll = "sequence";
var $_ = (t9) => t9.match(/^\s*sequenceDiagram/) !== null;
var D_ = async () => {
  const { diagram: t9 } = await import("./sequenceDiagram-5e6de89c-66ASHKK3.js");
...
var P_ = async () => {
  const { diagram: t9 } = await import("./classDiagram-a3547413-YU6LXWNS.js");
...
var j_ = async () => {
  const { diagram: t9 } = await import("./classDiagram-v2-60cd73ae-P4Q65B4T.js");
...
var V_ = async () => {
  const { diagram: t9 } = await import("./stateDiagram-eed21683-QHTJBZPN.js");
...
var J_ = async () => {
  const { diagram: t9 } = await import("./stateDiagram-v2-2a8ef368-IAQ3UL4T.js");
...
var ty = Q_;
var dl = "journey";
var ey = (t9) => t9.match(/^\s*journey/) !== null;
var iy = async () => {
  const { diagram: t9 } = await import("./journeyDiagram-eeb24d29-2QQVPSXP.js");
...
var fy = async () => {
  const { diagram: t9 } = await import("./flowchart-elk-definition-b299cff1-SWTYDA53.js");
...
var py = dy;
var ml = "timeline";
var gy = (t9) => t9.match(/^\s*timeline/) !== null;
var my = async () => {
  const { diagram: t9 } = await import("./timeline-definition-afaf264f-CE5WJG2D.js");
...
var yy = _y;
var _l = "mindmap";
var Cy = (t9) => t9.match(/^\s*mindmap/) !== null;
var xy = async () => {
  const { diagram: t9 } = await import("./mindmap-definition-825812a2-GFV6NXDZ.js");
...
var Zo = false;
var Pn = () => {
  Zo || (Zo = true, Ji("error", cy, (t9) => t9.toLowerCase().trim() === "error"), Ji(
    "---",
...
var Sy = (t9) => t9.trimStart().replace(/^\s*%%(?!{)[^\n]+\n?/gm, "");
var yl = class {
  constructor(e) {
    var o, s;
...
function Cl(t9) {
  var e = t9 && t9.constructor, i = typeof e == "function" && e.prototype || vy;
  return t9 === i;
}
function wy(t9, e) {
  return function(i) {
...
var Ay = Ly.hasOwnProperty;
function Ey(t9) {
  if (!Cl(t9))
    return Fy(t9);
  var e = [];
  for (var i in Object(t9))
    Ay.call(t9, i) && i != "constructor" && e.push(i);
  return e;
}
...
(cn && se(new cn(new ArrayBuffer(1))) != is || tr && se(new tr()) != Jo || un && se(un.resolve()) != Qo || fn && se(new fn()) != ts || dn && se(new dn()) != es) && (se = function(t9) {
  var e = ai(t9), i = e == Dy ? t9.constructor : void 0, r = i ? pe(i) : "";
  if (r)
    switch (r) {
      case Ny:
        return is;
...
function rs(t9) {
  return Wn(t9) && ai(t9) == Hy;
}
var xl = Object.prototype;
var jy = xl.hasOwnProperty;
var Uy = xl.propertyIsEnumerable;
var Yy = rs(function() {
  return arguments;
}()) ? rs : function(t9) {
  return Wn(t9) && jy.call(t9, "callee") && !Uy.call(t9, "callee");
};
var Gy = Yy;
...
function bl(t9) {
  return typeof t9 == "number" && t9 > -1 && t9 % 1 == 0 && t9 <= Ky;
}
function Zy(t9) {
...
var Qy = ns && ns.exports === Tl;
var os = Qy ? ie.Buffer : void 0;
var tC = os ? os.isBuffer : void 0;
var eC = tC || Jy;
var iC = eC;
...
var sC = "[object Date]";
var aC = "[object Error]";
var lC = "[object Function]";
var hC = "[object Map]";
var cC = "[object Number]";
var uC = "[object Object]";
var fC = "[object RegExp]";
var dC = "[object Set]";
var pC = "[object String]";
var gC = "[object WeakMap]";
var mC = "[object ArrayBuffer]";
var _C = "[object DataView]";
var yC = "[object Float32Array]";
var CC = "[object Float64Array]";
var xC = "[object Int8Array]";
var bC = "[object Int16Array]";
var TC = "[object Int32Array]";
var SC = "[object Uint8Array]";
var kC = "[object Uint8ClampedArray]";
var vC = "[object Uint16Array]";
var wC = "[object Uint32Array]";
var Y = {};
Y[yC] = Y[CC] = Y[xC] = Y[bC] = Y[TC] = Y[SC] = Y[kC] = Y[vC] = Y[wC] = true;
Y[rC] = Y[nC] = Y[mC] = Y[oC] = Y[_C] = Y[sC] = Y[aC] = Y[lC] = Y[hC] = Y[cC] = Y[uC] = Y[fC] = Y[dC] = Y[pC] = Y[gC] = false;
function BC(t9) {
...
var LC = Ge && Ge.exports === Sl;
var jr = LC && Pa.process;
var AC = function() {
  try {
...
var DC = $C.hasOwnProperty;
function Di(t9) {
  if (t9 == null)
    return true;
  if (Zy(t9) && (Xy(t9) || typeof t9 == "string" || typeof t9.splice == "function" || iC(t9) || MC(t9) || Gy(t9)))
    return !t9.length;
  var e = Wy(t9);
  if (e == OC || e == IC)
    return !t9.size;
...
var NC = "graphics-document document";
function RC(t9, e) {
  t9.attr("role", NC), Di(e) || t9.attr("aria-roledescription", e);
}
function qC(t9, e, i, r) {
  if (t9.insert !== void 0)
    if (e || i) {
      if (i) {
...
var PC = 5e4;
var zC = "graph TB;a[Maximum text size in diagram exceeded];style a fill:#faa";
var WC = "sandbox";
var HC = "loose";
var jC = "http://www.w3.org/2000/svg";
var UC = "http://www.w3.org/1999/xlink";
var YC = "http://www.w3.org/1999/xhtml";
var GC = "100%";
var VC = "100%";
var XC = "border:0;margin:0;";
var KC = "margin:0";
var ZC = "allow-top-navigation-by-user-activation allow-popups";
var JC = 'The "iframe" tag is not supported by your browser.';
var QC = ["foreignobject"];
var tx = ["dominant-baseline"];
async function ex(t9, e) {
  Pn();
  try {
    (await zn(t9)).parse();
  } catch (i) {
...
var ox = (t9, e, i, r) => {
  const n = nx(t9, e, i), o = Gg(e, n, t9.themeVariables);
  return ln(Y0(`${r}{${o}}`), V0);
};
var sx = (t9 = "", e, i) => {
  let r = t9;
...
var ax = (t9 = "", e) => {
  const i = e ? e.viewBox.baseVal.height + "px" : VC, r = btoa('<body style="' + KC + '">' + t9 + "</body>");
...
`), e = e.replace(
  ...
  if (i !== void 0) {
    if (i && (i.innerHTML = ""), u) {
      ...
      c = At(i);
    hs(c, t9, l, `font-family: ${p}`, UC);
  } else {
    if (lx(document, t9, l, s), u) {
  ...
  ux(q, W, Yt, K), c.select(`[id="${t9}"]`).selectAll("foreignobject > *").attr("xmlns", YC);
...
function ux(t9, e, i, r) {
  RC(e, t9), qC(e, i, r, e.attr("id"));
}
...
var dx = async function({ postRenderCallback: t9, querySelector: e, nodes: i } = {
  querySelector: ".mermaid"
}) {
...
var _x = async (t9, e) => new Promise((i, r) => {
...
mermaid/dist/mermaid-08b2ff5f.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5KIEU262.js.map
