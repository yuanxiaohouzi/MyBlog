...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/gitGraphDiagram-bd04333d.js
var me = function() {
  var r = function(B, l, u, b) {
    ...
    parse: function(l) {
      ...
      for (var S2, Y, D, le, U = {}, $, z, de2, ee; ; ) {
        if (Y = b[b.length - 1], this.defaultActions[Y] ? D = this.defaultActions[Y] : ((S2 === null || typeof S2 > "u") && (S2 = Me()), D = W[Y] && W[Y][S2]), typeof D > "u" || !D.length || !D[0]) {
          var he = "";
          ee = [];
          for ($ in W[Y])
...
` + L.showPosition() + `
Expecting ` + ee.join(", ") + ", got '" + (this.terminals_[S2] || S2) + "'" : he = "Parse error on line " + (Z + 1) + ": Unexpected " + (S2 == ge ? "end of input" : "'" + (this.terminals_[S2] || S2) + "'"), this.parseError(he, {
            text: L.match,
        ...
        if (D[0] instanceof Array && D.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + Y + ", token: " + S2);
        switch (D[0]) {
          case 1:
            b.push(S2), E.push(L.yytext), e.push(L.yylloc), b.push(D[1]), S2 = null, be = L.yyleng, t = L.yytext, Z = L.yylineno, oe = L.yylloc;
            break;
          case 2:
            if (z = this.productions_[D[1]][1], U.$ = E[E.length - z], U._$ = {
              ...
              return le;
            z && (b = b.slice(0, -1 * z * 2), E = E.slice(0, -1 * z), e = e.slice(0, -1 * z)), b.push(this.productions_[D[1]][0]), E.push(U.$), e.push(U._$), de2 = W[b[b.length - 2]][b[b.length - 1]], b.push(de2);
            break;
          case 3:
            return true;
        }
    ...
    var B = {
      ...
      setInput: function(l, u) {
        return this.yy = u || this.yy || {}, this._input = l, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
...
` + u + "^";
      ...
      next: function() {
        ...
        for (var E = this._currentRules(), e = 0; e < E.length; e++)
          if (b = this._input.match(this.rules[E[e]]), b && (!u || b[0].length > u[0].length)) {
            if (u = b, i = e, this.options.backtrack_lexer) {
              if (l = this.test_match(b, E[e]), l !== false)
                return l;
              if (this._backtrack) {
                u = false;
                continue;
        ...
        return u ? (l = this.test_match(u, E[i]), l !== false ? l : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
me.parser = me;
var Be = me;
var te = Ut().gitGraph.mainBranchName;
var qe = Ut().gitGraph.mainBranchOrder;
var R = {};
var O = null;
var Q = {};
...
var Ye = function(r, n, o) {
  de.parseDirective(this, r, n, o);
};
function Fe(r, n) {
  const o = /* @__PURE__ */ Object.create(null);
  return r.reduce((h, a) => {
    const c = n(a);
    return o[c] || (o[c] = true, h.push(a)), h;
  }, []);
}
var Ke = function(r) {
  xe = r;
...
var Je = function(r, n, o, h) {
  S.debug("Entering commit:", r, n, o, h), n = Fn.sanitizeText(n, Ut()), r = Fn.sanitizeText(r, Ut()), h = Fn.sanitizeText(h, Ut());
  const a = {
    id: n || K + "-" + fe(),
    message: r,
    seq: K++,
  ...
  O = a, R[a.id] = a, T[M] = a.id, S.debug("in pushCommit " + a.id);
};
var Qe = function(r, n) {
  if (r = Fn.sanitizeText(r, Ut()), T[r] === void 0)
    T[r] = O != null ? O.id : null, Q[r] = { name: r, order: n ? parseInt(n, 10) : null }, Ee(r), S.debug("in createBranch");
  else {
    let o = new Error(
...
var Xe = function(r, n, o, h) {
  r = Fn.sanitizeText(r, Ut()), n = Fn.sanitizeText(n, Ut());
  ...
  O = f, R[f.id] = f, T[M] = f.id, S.debug(T), S.debug("in mergeBranch");
};
var Ze = function(r, n, o) {
  if (S.debug("Entering cherryPick:", r, n, o), r = Fn.sanitizeText(r, Ut()), n = Fn.sanitizeText(n, Ut()), o = Fn.sanitizeText(o, Ut()), !r || R[r] === void 0) {
    let c = new Error(
  ...
  if (!n || R[n] === void 0) {
    ...
    O = f, R[f.id] = f, T[M] = f.id, S.debug(T), S.debug("in cherryPick");
  }
};
var Ee = function(r) {
  if (r = Fn.sanitizeText(r, Ut()), T[r] === void 0) {
...
function we(r) {
  ...
  for (let a in T)
    T[a] === n.id && h.push(a);
  if (S.debug(h.join(" ")), n.parents && n.parents.length == 2) {
...
var et = function() {
  R = {}, O = null;
  let r = Ut().gitGraph.mainBranchName, n = Ut().gitGraph.mainBranchOrder;
  T = {}, T[r] = null, Q = {}, Q[r] = { name: r, order: n }, M = r, K = 0, Fa();
};
var tt = function() {
...
var _e = (r, n, o) => {
  const h = Da().gitGraph, a = r.append("g").attr("class", "commit-bullets"), c = r.append("g").attr("class", "commit-labels");
  let f = 0;
...
var ht = (r, n, o) => Object.keys(o).filter((c) => o[c].branch === n.branch && o[c].seq > r.seq && o[c].seq < n.seq).length > 0;
var ue = (r, n, o = 0) => {
...
var pt = (r, n) => {
  const o = Da().gitGraph, h = r.append("g");
  n.forEach((a, c) => {
    ...
    let C = m.getBBox();
    d.attr("class", "branchLabelBkg label" + f).attr("rx", 4).attr("ry", 4).attr("x", -C.width - 4 - (o.rotateCommitLabel === true ? 30 : 0)).attr("y", -C.height / 2 + 8).attr("width", C.width + 18).attr("height", C.height + 4), s.attr(
      "transform",
      "translate(" + (-C.width - 14 - (o.rotateCommitLabel === true ? 30 : 0)) + ", " + (p - C.height / 2 - 1) + ")"
    ), d.attr("transform", "translate(-19, " + (p - C.height / 2) + ")");
  });
};
var ft = function(r, n, o, h) {
  ot();
  const a = Da(), c = a.gitGraph;
...
`, "id:", n, o), J = h.db.getCommits();
  ...
  const w = At(`[id="${n}"]`);
  _e(w, J, false), c.showBranches && pt(w, f), ut(w, J), _e(w, J, true), Oi.insertTitle(
    w,
    "gitTitleText",
    c.titleTopMargin,
...
//# sourceMappingURL=gitGraphDiagram-bd04333d-D6ITPYZO.js.map
