...
// node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/requirementDiagram-480c4b33.js
var he = function() {
  var e = function(q, r, s, l) {
    for (s = s || {}, l = q.length; l--; s[q[l]] = r)
      ;
    return s;
  }, t = [1, 3], a = [1, 5], c = [1, 6], d = [1, 7], u = [1, 8], p = [5, 6, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 71, 72], h = [1, 22], o = [2, 13], g = [1, 26], R = [1, 27], x = [1, 28], S3 = [1, 29], T = [1, 30], v = [1, 31], A2 = [1, 24], N = [1, 32], w = [1, 33], pe = [1, 36], F = [71, 72], fe = [5, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 60, 62, 71, 72], _e = [1, 56], ye = [1, 57], ge = [1, 58], Ee = [1, 59], Re = [1, 60], me = [1, 61], Ie = [1, 62], O = [62, 63], M = [1, 74], P = [1, 70], Y = [1, 71], U = [1, 72], B = [1, 73], Q = [1, 75], j = [1, 79], X = [1, 80], J = [1, 77], Z = [1, 78], m = [5, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 71, 72], re = {
    trace: function() {
    },
    yy: {},
...
Expecting ` + ie.join(", ") + ", got '" + (this.terminals_[I] || I) + "'" : ce = "Parse error on line " + (ee + 1) + ": Unexpected " + (I == ke ? "end of input" : "'" + (this.terminals_[I] || I) + "'"), this.parseError(ce, {
    ...
    var q = {
      ...
      setInput: function(r, s) {
        return this.yy = s || this.yy || {}, this._input = r, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
...
` + s + "^";
      ...
      next: function() {
        ...
        for (var _ = this._currentRules(), n = 0; n < _.length; n++)
          if (l = this._input.match(this.rules[_[n]]), l && (!s || l[0].length > s[0].length)) {
            if (s = l, i = n, this.options.backtrack_lexer) {
              if (r = this.test_match(l, _[n]), r !== false)
                return r;
              if (this._backtrack) {
                s = false;
                continue;
        ...
        return s ? (r = this.test_match(s, _[i]), r !== false ? r : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
var Ze = function(e, t, a) {
  de.parseDirective(this, e, t, a);
};
var et = (e, t) => (G[e] === void 0 && (G[e] = {
  name: e,
  type: t,
  id: b.id,
  text: b.text,
...
var at = (e) => (z[e] === void 0 && (z[e] = {
  name: e,
  type: L.type,
  docRef: L.docRef
}, S2.info("Added new requirement: ", e)), L = {}, z[e]);
var lt = () => z;
var ct = (e) => {
  L !== void 0 && (L.type = e);
};
...
var y = {};
var Ne = 0;
var we = (e, t) => e.insert("rect", "#" + t).attr("class", "req reqBox").attr("x", 0).attr("y", 0).attr("width", y.rect_min_width + "px").attr("height", y.rect_min_height + "px");
var Ve = (e, t, a) => {
...
var Et = function(e, t, a, c, d) {
  const u = a.edge(W(t.src), W(t.dst)), p = S().x(function(o) {
    return o.x;
  }).y(function(o) {
    return o.y;
  ...
  t.type == d.db.Relationships.CONTAINS ? h.attr(
    "marker-start",
    "url(" + Fn.getUrl(y.arrowMarkerAbsolute) + "#" + t.type + "_line_ending)"
  ) : (h.attr("stroke-dasharray", "10,7"), h.attr(
    "marker-end",
    "url(" + Fn.getUrl(y.arrowMarkerAbsolute) + "#" + Ae.ReqMarkers.ARROW + "_line_ending)"
  )), gt(e, h, y, `<<${t.type}>>`);
};
var Rt = (e, t, a) => {
  Object.keys(e).forEach((c) => {
    let d = e[c];
    c = W(c), S2.info("Added new requirement: ", c);
...
var It = (e, t) => (e.forEach(function(a) {
...
var W = (e) => e.replace(/\s/g, "").replace(/\./g, "_");
var kt = (e, t, a, c) => {
  y = Ut().requirement, c.db.clear(), c.parser.parse(e);
  const d = y.securityLevel;
  let u;
  d === "sandbox" && (u = At("#i" + t));
  const h = (d === "sandbox" ? At(u.nodes()[0].contentDocument.body) : At("body")).select(`[id='${t}']`);
  ...
  Rt(g, o, h), mt(R, o, h), It(x, o), zs(o), bt(h, o), x.forEach(function(N) {
    Et(h, N, o, t, c);
  });
  const S3 = y.rect_padding, T = h.node().getBBox(), v = T.width + S3 * 2, A2 = T.height + S3 * 2;
  Hg(h, A2, v, y.useMaxWidth), h.attr("viewBox", `${T.x - S3} ${T.y - S3} ${v} ${A2}`);
};
var St = {
  draw: kt
};
...
//# sourceMappingURL=requirementDiagram-480c4b33-FUBZ25JD.js.map
